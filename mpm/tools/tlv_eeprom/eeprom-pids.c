...
static struct pid_info pid_list[] = {
    {0xa410, "x410", "X410 Module", 0, NULL},
    {0xa420, "x420", "X420 Module", 0, NULL},
    {0xa440, "x440", "X440 Module", 0, NULL},
    {0x0410, "x410", "X410 Motherboard", 0, NULL},
    {0x0420, "x420", "X420 Motherboard", 0, NULL},
    {0x0440, "x440", "X440 Motherboard", 0, NULL},
    {0x4000, NULL, "Power Aux Board", 0, NULL},
    {0x4001, NULL, "Debug RF DB", 0, NULL},
    {0x4002, "zbx", "ZBX RF DB", 0, NULL},
    {0x4003, NULL, "HDMI SE DIO Aux Board", 0, NULL},
    {0x4004, NULL, "Clocking Aux Board with GPSDO", 0, NULL},
    {0x4005, NULL, "Clocking Aux Board (no GPSDO)", 0, NULL},
