...
//
// Module: axis_hb_cascade_decim_all_tb.sv
//
// Description: Testbench wrapper to run all AXI halfband filter cascade decimator tests
//

`default_nettype none

module axis_hb_cascade_decim_all_tb ();
...
endmodule : axis_hb_cascade_decim_all_tb
