...
################################################################
# This is a generated script based on design: axi_intercon_2x64_256_bd
#
...
# source axi_intercon_2x64_256_bd_script.tcl
...
set design_name axi_intercon_2x64_256_bd
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLK_DOMAIN {axi_intercon_2x64_256_bd_M00_ACLK} \
 ] $M00_AXI_ACLK
  set M00_AXI_ARESETN [ create_bd_port -dir I -type rst M00_AXI_ARESETN ]
  set S00_AXI_ACLK [ create_bd_port -dir I -type clk -freq_hz 1000000000 S00_AXI_ACLK ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_RESET {S00_AXI_ARESETN} \
   CONFIG.CLK_DOMAIN {axi_intercon_2x64_256_bd_S00_ACLK} \
 ] $S00_AXI_ACLK
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLK_DOMAIN {axi_intercon_2x64_256_bd_S01_ACLK} \
 ] $S01_AXI_ACLK
  ...
  connect_bd_net -net M00_AXI_ACLK_1 [get_bd_ports M00_AXI_ACLK] [get_bd_pins m00_rs/aclk] [get_bd_pins s00_rs_1/aclk] [get_bd_pins s00_width_conv/m_axi_aclk] [get_bd_pins s01_rs_1/aclk] [get_bd_pins s01_width_conv/m_axi_aclk] [get_bd_pins xbar/aclk]
  connect_bd_net -net M00_AXI_ARESETN_1 [get_bd_ports M00_AXI_ARESETN] [get_bd_pins m00_rs/aresetn] [get_bd_pins s00_rs_1/aresetn] [get_bd_pins s00_width_conv/m_axi_aresetn] [get_bd_pins s01_rs_1/aresetn] [get_bd_pins s01_width_conv/m_axi_aresetn] [get_bd_pins xbar/aresetn]
