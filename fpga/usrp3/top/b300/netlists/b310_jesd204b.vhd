...
entity b310_jesd204b is
  port (
    ...
    rclk_fpga_clocks_stable : in std_logic;
    jesd_ref_clk_p : in std_logic;
    jesd_ref_clk_n : in std_logic;
    rclk_jesd_ref_clk_present : out std_logic;
    lmk_sync : out std_logic;
    rclk_ctrlport_req_wr : in std_logic;
    rclk_ctrlport_req_rd : in std_logic;
    rclk_ctrlport_req_addr : in std_logic_vector(19 downto 0);
    rclk_ctrlport_req_port_id : in std_logic_vector(9 downto 0);
    rclk_ctrlport_req_rem_epid : in std_logic_vector(15 downto 0);
    rclk_ctrlport_req_rem_portid : in std_logic_vector(9 downto 0);
    rclk_ctrlport_req_data : in std_logic_vector(31 downto 0);
    rclk_ctrlport_req_byte_en : in std_logic_vector(3 downto 0);
    rclk_ctrlport_req_has_time : in std_logic;
    rclk_ctrlport_req_time : in std_logic_vector(63 downto 0);
    rclk_ctrlport_resp_ack : out std_logic;
    rclk_ctrlport_resp_status : out std_logic_vector(1 downto 0);
    rclk_ctrlport_resp_data : out std_logic_vector(31 downto 0);
