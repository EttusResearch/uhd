...
module rfnoc_image_core #(
  ...
  chdr_crossbar_nxn #(
    .PORT_W         (PORT_W),
    .NPORTS         (6),
    .CHDR_WIDTHS    ({EP3_W, EP2_W, EP1_W, EP0_W, DMA_W, ETH_W}),
    .DEFAULT_PORT   (0),
    .ROUTES         ({ 6'b111111,
                       6'b111111,
                       6'b111111,
  ...
  wire                    fifo0_mem_clk;
  wire [BLOCK_CHDR_W-1:0] s_fifo0_in_1_tdata , s_fifo0_in_0_tdata ;
  ...
  wire [BLOCK_CHDR_W-1:0] m_fifo0_out_1_tdata , m_fifo0_out_0_tdata ;
