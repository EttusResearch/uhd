...
################################################################
# This is a generated script based on design: x420_ps_rfdc_bd
#
...
# source x420_ps_rfdc_bd_script.tcl
...
set design_name x420_ps_rfdc_bd
...
The format of the ADC/DAC maps is documented in x420_rfdc_memory_content_pkg.sv." [get_bd_designs $design_name]
...
proc create_hier_cell_calibration_muxes { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 m_axis_7
  ...
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins m_axis_3] [get_bd_intf_pins gpio_to_axis_mux_0/m_axis_3]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins m_axis_7] [get_bd_intf_pins gpio_to_axis_mux_0/m_axis_7]
  ...
  connect_bd_intf_net -intf_net dac_tile229_ch2_din_1 [get_bd_intf_pins dac_tile229_ch3_din] [get_bd_intf_pins gpio_to_axis_mux_0/s_axis_7]
...
proc create_hier_cell_rfdc { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir O adc_enable_data_r0clk
  create_bd_pin -dir O adc_enable_data_r1clk
  create_bd_pin -dir I adc_reset_pulse_r0clk
  create_bd_pin -dir I adc_reset_pulse_r1clk
  ...
  create_bd_pin -dir O dac_data_in_resetn_r1clk2x
  create_bd_pin -dir I dac_reset_pulse_r0clk
  create_bd_pin -dir I dac_reset_pulse_r1clk
  ...
  create_bd_pin -dir I enable_sysref_r0clk
  create_bd_pin -dir O gated_base_clks_valid_clk40
  create_bd_pin -dir O nco_reset_done_r0clk
  ...
  create_bd_pin -dir O radio1_rfdc_clk_1x
  create_bd_pin -dir O radio1_rfdc_clk_2x
  ...
  create_bd_pin -dir I -type rst s_axi_config_aresetn
  create_bd_pin -dir I -type clk s_axi_config_clk
  create_bd_pin -dir I start_nco_reset_r0clk
  create_bd_pin -dir O sysref_out_pclk
  create_bd_pin -dir O sysref_out_r0clk
  ...
  # Create instance: axi_stream_split_0, and set properties
  set block_name axi_stream_split
  set block_cell_name axi_stream_split_0
  if { [catch {set axi_stream_split_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axi_stream_split_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: axi_stream_split_1, and set properties
  set block_name axi_stream_split
  set block_cell_name axi_stream_split_1
  if { [catch {set axi_stream_split_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axi_stream_split_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  set_property -dict [ list \
   ...
   CONFIG.PHASE {0} \
   CONFIG.CLK_DOMAIN {x420_ps_rfdc_bd_pll_ref_clk_in} \
  ...
  set block_name x420_clock_gates
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT2_JITTER {99.756} \
   CONFIG.CLKOUT2_PHASE_ERROR {128.385} \
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {320} \
   CONFIG.CLKOUT2_USED {true} \
   CONFIG.CLKOUT3_DRIVES {BUFGCE} \
   CONFIG.CLKOUT3_JITTER {99.756} \
   CONFIG.CLKOUT3_PHASE_ERROR {128.385} \
   CONFIG.CLKOUT3_REQUESTED_OUT_FREQ {320} \
   CONFIG.CLKOUT3_USED {true} \
   CONFIG.CLKOUT4_DRIVES {BUFG} \
   CONFIG.CLKOUT4_JITTER {89.173} \
   CONFIG.CLKOUT4_PHASE_ERROR {128.385} \
   CONFIG.CLKOUT4_REQUESTED_OUT_FREQ {640} \
   CONFIG.CLKOUT4_USED {true} \
   CONFIG.CLKOUT5_DRIVES {BUFGCE} \
   CONFIG.CLKOUT5_JITTER {89.173} \
   CONFIG.CLKOUT5_PHASE_ERROR {128.385} \
   CONFIG.CLKOUT5_REQUESTED_OUT_FREQ {640} \
   CONFIG.CLKOUT5_USED {true} \
   CONFIG.CLKOUT6_DRIVES {BUFGCE} \
   CONFIG.CLKOUT6_JITTER {99.756} \
   CONFIG.CLKOUT6_PHASE_ERROR {128.385} \
   CONFIG.CLKOUT6_REQUESTED_OUT_FREQ {320} \
   CONFIG.CLKOUT6_USED {true} \
   CONFIG.CLKOUT7_DRIVES {BUFGCE} \
   CONFIG.CLKOUT7_JITTER {89.173} \
   CONFIG.CLKOUT7_PHASE_ERROR {128.385} \
   CONFIG.CLKOUT7_REQUESTED_OUT_FREQ {640} \
  ...
  # Create instance: db0_data_path_mux_i, and set properties
  set block_name axi_stream_select
  set block_cell_name db0_data_path_mux_i
  if { [catch {set db0_data_path_mux_i [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $db0_data_path_mux_i eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  # Create instance: db0_data_path_mux_q, and set properties
  set block_name axi_stream_select
  set block_cell_name db0_data_path_mux_q
  if { [catch {set db0_data_path_mux_q [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $db0_data_path_mux_q eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  # Create instance: db1_data_path_mux_i, and set properties
  set block_name axi_stream_select
  set block_cell_name db1_data_path_mux_i
  if { [catch {set db1_data_path_mux_i [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $db1_data_path_mux_i eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  # Create instance: db1_data_path_mux_q, and set properties
  set block_name axi_stream_select
  set block_cell_name db1_data_path_mux_q
  if { [catch {set db1_data_path_mux_q [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $db1_data_path_mux_q eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  set_property -dict [ list \
   ...
   CONFIG.ADC0_Fabric_Freq {320.000} \
   CONFIG.ADC0_Link_Coupling {1} \
   CONFIG.ADC0_Multi_Tile_Sync {true} \
   CONFIG.ADC0_Outclk_Freq {20.000} \
   CONFIG.ADC0_PLL_Enable {true} \
   CONFIG.ADC0_Refclk_Freq {320.000} \
   CONFIG.ADC0_Sampling_Rate {2.56} \
   CONFIG.ADC1_Enable {1} \
   CONFIG.ADC1_Fabric_Freq {320.000} \
   CONFIG.ADC1_Link_Coupling {0} \
   CONFIG.ADC1_Multi_Tile_Sync {true} \
   CONFIG.ADC1_Outclk_Freq {20.000} \
   CONFIG.ADC1_PLL_Enable {true} \
   CONFIG.ADC1_Refclk_Freq {320.000} \
   CONFIG.ADC1_Sampling_Rate {2.56} \
   CONFIG.ADC224_En {true} \
   CONFIG.ADC225_En {false} \
   CONFIG.ADC2_Enable {1} \
   CONFIG.ADC2_Fabric_Freq {320.000} \
   CONFIG.ADC2_Link_Coupling {1} \
   CONFIG.ADC2_Multi_Tile_Sync {true} \
   CONFIG.ADC2_Outclk_Freq {20.000} \
   CONFIG.ADC2_PLL_Enable {true} \
   CONFIG.ADC2_Refclk_Freq {320.000} \
   CONFIG.ADC2_Sampling_Rate {2.56} \
   CONFIG.ADC3_Enable {1} \
   CONFIG.ADC3_Fabric_Freq {320.000} \
   CONFIG.ADC3_Link_Coupling {0} \
   CONFIG.ADC3_Multi_Tile_Sync {true} \
   CONFIG.ADC3_Outclk_Freq {20.000} \
   CONFIG.ADC3_PLL_Enable {true} \
   CONFIG.ADC3_Refclk_Freq {320.000} \
   CONFIG.ADC3_Sampling_Rate {2.56} \
   ...
   CONFIG.ADC_Mixer_Mode00 {1} \
   CONFIG.ADC_Mixer_Mode01 {1} \
   CONFIG.ADC_Mixer_Mode02 {1} \
   CONFIG.ADC_Mixer_Mode03 {1} \
   ...
   CONFIG.ADC_Mixer_Mode21 {1} \
   CONFIG.ADC_Mixer_Mode22 {1} \
   CONFIG.ADC_Mixer_Mode23 {1} \
   ...
   CONFIG.DAC_NCO_Freq01 {0} \
   CONFIG.DAC_NCO_Freq02 {0.0} \
   CONFIG.DAC_NCO_Freq03 {0.2} \
   CONFIG.DAC_NCO_Freq10 {0.200} \
   CONFIG.DAC_NCO_Freq11 {0} \
   CONFIG.DAC_NCO_Freq12 {0.0} \
   CONFIG.DAC_NCO_Freq13 {0.2} \
  ...
  set block_name x420_rf_reset_controller
  ...
  # Create instance: scale_2x_db0_i, and set properties
  set block_name scale_2x
  set block_cell_name scale_2x_db0_i
  if { [catch {set scale_2x_db0_i [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $scale_2x_db0_i eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.kDataWidth {64} \
 ] $scale_2x_db0_i

  # Create instance: scale_2x_db0_q, and set properties
  set block_name scale_2x
  set block_cell_name scale_2x_db0_q
  if { [catch {set scale_2x_db0_q [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $scale_2x_db0_q eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  # Create instance: scale_2x_db1_i, and set properties
  set block_name scale_2x
  set block_cell_name scale_2x_db1_i
  if { [catch {set scale_2x_db1_i [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $scale_2x_db1_i eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  # Create instance: scale_2x_db1_q, and set properties
  set block_name scale_2x
  set block_cell_name scale_2x_db1_q
  if { [catch {set scale_2x_db1_q [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $scale_2x_db1_q eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  # Create instance: slice_data_path_select_radio0_rx, and set properties
  set slice_data_path_select_radio0_rx [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_data_path_select_radio0_rx ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {20} \
   CONFIG.DIN_TO {20} \
   CONFIG.DOUT_WIDTH {1} \
 ] $slice_data_path_select_radio0_rx

  # Create instance: slice_data_path_select_radio0_tx, and set properties
  set slice_data_path_select_radio0_tx [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_data_path_select_radio0_tx ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {16} \
   CONFIG.DIN_TO {16} \
   CONFIG.DOUT_WIDTH {1} \
 ] $slice_data_path_select_radio0_tx

  # Create instance: slice_data_path_select_radio1_rx, and set properties
  set slice_data_path_select_radio1_rx [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_data_path_select_radio1_rx ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {20} \
   CONFIG.DIN_TO {20} \
   CONFIG.DOUT_WIDTH {1} \
 ] $slice_data_path_select_radio1_rx

  # Create instance: slice_data_path_select_radio1_tx, and set properties
  set slice_data_path_select_radio1_tx [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 slice_data_path_select_radio1_tx ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {16} \
   CONFIG.DIN_TO {16} \
   CONFIG.DOUT_WIDTH {1} \
 ] $slice_data_path_select_radio1_tx
  ...
  connect_bd_intf_net -intf_net adc_tile224_ch1_vin_1 [get_bd_intf_pins adc_tile224_ch1_vin] [get_bd_intf_pins rf_data_converter/vin0_23]
  connect_bd_intf_net -intf_net adc_tile226_ch1_vin_1 [get_bd_intf_pins adc_tile226_ch1_vin] [get_bd_intf_pins rf_data_converter/vin2_23]
  ...
  connect_bd_intf_net -intf_net axi_stream_select_0_m_axis [get_bd_intf_pins adc_tile224_ch0_dout_i] [get_bd_intf_pins db0_data_path_mux_i/m_axis]
  connect_bd_intf_net -intf_net axi_stream_select_1_m_axis [get_bd_intf_pins adc_tile224_ch0_dout_q] [get_bd_intf_pins db0_data_path_mux_q/m_axis]
  connect_bd_intf_net -intf_net axi_stream_split_0_m_axis_1 [get_bd_intf_pins axi_stream_split_0/m_axis_1] [get_bd_intf_pins calibration_muxes/dac_tile228_ch3_din]
  connect_bd_intf_net -intf_net axi_stream_split_1_m_axis_1 [get_bd_intf_pins axi_stream_split_1/m_axis_1] [get_bd_intf_pins calibration_muxes/dac_tile229_ch3_din]
  ...
  connect_bd_intf_net -intf_net calibration_muxes_m_axis_3 [get_bd_intf_pins calibration_muxes/m_axis_3] [get_bd_intf_pins rf_data_converter/s03_axis]
  connect_bd_intf_net -intf_net calibration_muxes_m_axis_7 [get_bd_intf_pins calibration_muxes/m_axis_7] [get_bd_intf_pins rf_data_converter/s13_axis]
  ...
  connect_bd_intf_net -intf_net dac_tile228_ch0_din_1 [get_bd_intf_pins axi_stream_split_0/m_axis_0] [get_bd_intf_pins calibration_muxes/dac_tile228_ch0_din]
  connect_bd_intf_net -intf_net dac_tile228_ch0_din_2 [get_bd_intf_pins dac_tile228_ch0_din] [get_bd_intf_pins axi_stream_split_0/s_axis]
  connect_bd_intf_net -intf_net dac_tile229_ch0_din_1 [get_bd_intf_pins axi_stream_split_1/m_axis_0] [get_bd_intf_pins calibration_muxes/dac_tile229_ch0_din]
  connect_bd_intf_net -intf_net dac_tile229_ch0_din_2 [get_bd_intf_pins dac_tile229_ch0_din] [get_bd_intf_pins axi_stream_split_1/s_axis]
  connect_bd_intf_net -intf_net db1_data_path_mux_i_m_axis [get_bd_intf_pins adc_tile226_ch0_dout_i] [get_bd_intf_pins db1_data_path_mux_i/m_axis]
  connect_bd_intf_net -intf_net db1_data_path_mux_q_m_axis [get_bd_intf_pins adc_tile226_ch0_dout_q] [get_bd_intf_pins db1_data_path_mux_q/m_axis]
  connect_bd_intf_net -intf_net rf_data_converter_m00_axis [get_bd_intf_pins db0_data_path_mux_i/s_axis_0] [get_bd_intf_pins rf_data_converter/m00_axis]
  connect_bd_intf_net -intf_net rf_data_converter_m01_axis [get_bd_intf_pins db0_data_path_mux_q/s_axis_0] [get_bd_intf_pins rf_data_converter/m01_axis]
  connect_bd_intf_net -intf_net rf_data_converter_m10_axis [get_bd_intf_pins db0_data_path_mux_i/s_axis_1] [get_bd_intf_pins rf_data_converter/m10_axis]
  connect_bd_intf_net -intf_net rf_data_converter_m11_axis [get_bd_intf_pins db0_data_path_mux_q/s_axis_1] [get_bd_intf_pins rf_data_converter/m11_axis]
  connect_bd_intf_net -intf_net rf_data_converter_m20_axis [get_bd_intf_pins db1_data_path_mux_i/s_axis_0] [get_bd_intf_pins rf_data_converter/m20_axis]
  connect_bd_intf_net -intf_net rf_data_converter_m21_axis [get_bd_intf_pins db1_data_path_mux_q/s_axis_0] [get_bd_intf_pins rf_data_converter/m21_axis]
  connect_bd_intf_net -intf_net rf_data_converter_m30_axis [get_bd_intf_pins db1_data_path_mux_i/s_axis_1] [get_bd_intf_pins rf_data_converter/m30_axis]
  connect_bd_intf_net -intf_net rf_data_converter_m31_axis [get_bd_intf_pins db1_data_path_mux_q/s_axis_1] [get_bd_intf_pins rf_data_converter/m31_axis]
  ...
  # Create port connections
  connect_bd_net -net In10_1 [get_bd_pins ThresholdRegister/In10] [get_bd_pins rf_data_converter/adc2_23_over_threshold1]
  connect_bd_net -net In11_1 [get_bd_pins ThresholdRegister/In11] [get_bd_pins rf_data_converter/adc2_23_over_threshold2]
  ...
  connect_bd_net -net clock_gates_0_aEnableRf1Bufg2x [get_bd_pins clock_gates_0/aEnableRf1Bufg2x] [get_bd_pins data_clock_mmcm/r1_rfdc_clk_2x_ce]
  ...
  connect_bd_net -net clock_gates_0_rf2EnableBufg [get_bd_pins clock_gates_0/aEnableRf0Bufg2x] [get_bd_pins data_clock_mmcm/r0_rfdc_clk_2x_ce]
  ...
  connect_bd_net -net radio1_rfdc_clk_ce_1 [get_bd_pins clock_gates_0/aEnableRf1Bufg1x] [get_bd_pins data_clock_mmcm/r1_rfdc_clk_ce]
  connect_bd_net -net reg_invert_iq_radio1_gpio_io_o [get_bd_pins reg_invert_iq_radio1/gpio_io_o] [get_bd_pins slice_data_path_select_radio1_rx/Din] [get_bd_pins slice_data_path_select_radio1_tx/Din] [get_bd_pins slice_iqswap_11_8_radio1/Din] [get_bd_pins slice_iqswap_3_0_radio1/Din]
  ...
  connect_bd_net -net rf_data_converter_adc1_nco_update_busy [get_bd_pins rf_data_converter/adc1_nco_update_busy] [get_bd_pins rf_nco_reset_wrapper_0/c_adc1_nco_update_busy]
  ...
  connect_bd_net -net rf_data_converter_adc3_nco_update_busy [get_bd_pins rf_data_converter/adc3_nco_update_busy] [get_bd_pins rf_nco_reset_wrapper_0/c_adc3_nco_update_busy]
  ...
  connect_bd_net -net rf_data_converter_m10_axis_tdata [get_bd_pins rf_data_converter/m10_axis_tdata] [get_bd_pins scale_2x_db0_i/cDataIn]
  connect_bd_net -net rf_data_converter_m10_axis_tvalid [get_bd_pins rf_data_converter/m10_axis_tvalid] [get_bd_pins scale_2x_db0_i/cDataValidIn]
  connect_bd_net -net rf_data_converter_m11_axis_tdata [get_bd_pins rf_data_converter/m11_axis_tdata] [get_bd_pins scale_2x_db0_q/cDataIn]
  connect_bd_net -net rf_data_converter_m11_axis_tvalid [get_bd_pins rf_data_converter/m11_axis_tvalid] [get_bd_pins scale_2x_db0_q/cDataValidIn]
  connect_bd_net -net rf_data_converter_m30_axis_tdata [get_bd_pins rf_data_converter/m30_axis_tdata] [get_bd_pins scale_2x_db1_i/cDataIn]
  connect_bd_net -net rf_data_converter_m30_axis_tvalid [get_bd_pins rf_data_converter/m30_axis_tvalid] [get_bd_pins scale_2x_db1_i/cDataValidIn]
  connect_bd_net -net rf_data_converter_m31_axis_tdata [get_bd_pins rf_data_converter/m31_axis_tdata] [get_bd_pins scale_2x_db1_q/cDataIn]
  connect_bd_net -net rf_data_converter_m31_axis_tvalid [get_bd_pins rf_data_converter/m31_axis_tvalid] [get_bd_pins scale_2x_db1_q/cDataValidIn]
  connect_bd_net -net rf_nco_reset_0_cDac1xNcoUpdateReq [get_bd_pins rf_data_converter/adc0_nco_update_req] [get_bd_pins rf_data_converter/adc1_nco_update_req] [get_bd_pins rf_data_converter/adc2_nco_update_req] [get_bd_pins rf_data_converter/adc3_nco_update_req] [get_bd_pins rf_data_converter/dac1_nco_update_req] [get_bd_pins rf_nco_reset_wrapper_0/c_all_other_nco_update_req]
  connect_bd_net -net rf_nco_reset_0_cNcoPhaseRst [get_bd_pins rf_data_converter/adc0_01_nco_phase_rst] [get_bd_pins rf_data_converter/adc1_01_nco_phase_rst] [get_bd_pins rf_data_converter/adc2_01_nco_phase_rst] [get_bd_pins rf_data_converter/adc3_01_nco_phase_rst] [get_bd_pins rf_data_converter/dac00_nco_phase_rst] [get_bd_pins rf_data_converter/dac10_nco_phase_rst] [get_bd_pins rf_nco_reset_wrapper_0/c_nco_phase_rst]
  connect_bd_net -net rf_nco_reset_0_cNcoUpdateEn [get_bd_pins rf_data_converter/adc0_01_nco_update_en] [get_bd_pins rf_data_converter/adc1_01_nco_update_en] [get_bd_pins rf_data_converter/adc2_01_nco_update_en] [get_bd_pins rf_data_converter/adc3_01_nco_update_en] [get_bd_pins rf_data_converter/dac00_nco_update_en] [get_bd_pins rf_data_converter/dac10_nco_update_en] [get_bd_pins rf_nco_reset_wrapper_0/c_nco_update_enable]
  ...
  connect_bd_net -net rf_nco_reset_wrapper_0_dNcoResetDone [get_bd_pins nco_reset_done_r0clk] [get_bd_pins rf_nco_reset_wrapper_0/d_nco_reset_done]
  ...
  connect_bd_net -net rf_reset_controller_0_rAdcRfdcAxiReset_n [get_bd_pins adc_rfdc_axi_resetn_r0clk] [get_bd_pins db0_data_path_mux_i/aresetn] [get_bd_pins db0_data_path_mux_q/aresetn] [get_bd_pins rf_data_converter/m0_axis_aresetn] [get_bd_pins rf_data_converter/m1_axis_aresetn] [get_bd_pins rf_reset_controller_0/rAdcReset_n]
  ...
  connect_bd_net -net rf_reset_controller_1_r2DacReset_n [get_bd_pins dac_data_in_resetn_r1clk2x] [get_bd_pins rf_reset_controller_1/r2DacReset_n]
  connect_bd_net -net rf_reset_controller_1_rAdcEnableData [get_bd_pins adc_enable_data_r1clk] [get_bd_pins rf_reset_controller_1/rAdcEnableData]
  connect_bd_net -net rf_reset_controller_1_rAdcReset_n [get_bd_pins adc_rfdc_axi_resetn_r1clk] [get_bd_pins db1_data_path_mux_i/aresetn] [get_bd_pins db1_data_path_mux_q/aresetn] [get_bd_pins rf_data_converter/m2_axis_aresetn] [get_bd_pins rf_data_converter/m3_axis_aresetn] [get_bd_pins rf_reset_controller_1/rAdcReset_n]
  connect_bd_net -net rf_reset_controller_1_rDacReset_n [get_bd_pins dac_data_in_resetn_r1clk] [get_bd_pins axi_stream_split_1/aresetn] [get_bd_pins rf_data_converter/s1_axis_aresetn] [get_bd_pins rf_reset_controller_1/rDacReset_n]
  ...
  connect_bd_net -net scale_2x_1_cDataValidOut [get_bd_pins db0_data_path_mux_i/s_axis_tvalid_1] [get_bd_pins scale_2x_db0_i/cDataValidOut]
  connect_bd_net -net scale_2x_ch0_i1_cDataOut [get_bd_pins db1_data_path_mux_i/s_axis_tdata_1] [get_bd_pins scale_2x_db1_i/cDataOut]
  connect_bd_net -net scale_2x_ch0_i1_cDataValidOut [get_bd_pins db1_data_path_mux_i/s_axis_tvalid_1] [get_bd_pins scale_2x_db1_i/cDataValidOut]
  connect_bd_net -net scale_2x_ch1_i1_cDataOut [get_bd_pins db1_data_path_mux_q/s_axis_tdata_1] [get_bd_pins scale_2x_db1_q/cDataOut]
  connect_bd_net -net scale_2x_ch1_i1_cDataValidOut [get_bd_pins db1_data_path_mux_q/s_axis_tvalid_1] [get_bd_pins scale_2x_db1_q/cDataValidOut]
  connect_bd_net -net slice_data_path_select_radio0_Dout [get_bd_pins axi_stream_split_0/mux_select] [get_bd_pins slice_data_path_select_radio0_tx/Dout]
  connect_bd_net -net slice_data_path_select_radio0_rx_Dout [get_bd_pins db0_data_path_mux_i/mux_select] [get_bd_pins db0_data_path_mux_q/mux_select] [get_bd_pins slice_data_path_select_radio0_rx/Dout]
  connect_bd_net -net slice_data_path_select_radio1_Dout [get_bd_pins axi_stream_split_1/mux_select] [get_bd_pins slice_data_path_select_radio1_tx/Dout]
  connect_bd_net -net slice_data_path_select_radio1_rx_Dout [get_bd_pins db1_data_path_mux_i/mux_select] [get_bd_pins db1_data_path_mux_q/mux_select] [get_bd_pins slice_data_path_select_radio1_rx/Dout]
  ...
  connect_bd_net -net x420_rf_reset_contro_0_rDacReset_n [get_bd_pins dac_data_in_resetn_r0clk] [get_bd_pins axi_stream_split_0/aresetn] [get_bd_pins rf_data_converter/s0_axis_aresetn] [get_bd_pins rf_reset_controller_0/rDacReset_n]
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set adc_enable_data_r0clk [ create_bd_port -dir O adc_enable_data_r0clk ]
  set adc_enable_data_r1clk [ create_bd_port -dir O adc_enable_data_r1clk ]
  set adc_reset_pulse_r0clk [ create_bd_port -dir I adc_reset_pulse_r0clk ]
  set adc_reset_pulse_r1clk [ create_bd_port -dir I adc_reset_pulse_r1clk ]
  set adc_rfdc_axi_resetn_r0clk [ create_bd_port -dir O adc_rfdc_axi_resetn_r0clk ]
  set adc_rfdc_axi_resetn_r1clk [ create_bd_port -dir O adc_rfdc_axi_resetn_r1clk ]
  ...
  set dac_data_in_resetn_r0clk [ create_bd_port -dir O dac_data_in_resetn_r0clk ]
  set dac_data_in_resetn_r0clk2x [ create_bd_port -dir O dac_data_in_resetn_r0clk2x ]
  set dac_data_in_resetn_r1clk [ create_bd_port -dir O dac_data_in_resetn_r1clk ]
  set dac_data_in_resetn_r1clk2x [ create_bd_port -dir O dac_data_in_resetn_r1clk2x ]
  set dac_reset_pulse_r0clk [ create_bd_port -dir I dac_reset_pulse_r0clk ]
  set dac_reset_pulse_r1clk [ create_bd_port -dir I dac_reset_pulse_r1clk ]
  ...
  set enable_sysref_r0clk [ create_bd_port -dir I enable_sysref_r0clk ]
  ...
  set nco_reset_done_r0clk [ create_bd_port -dir O nco_reset_done_r0clk ]
  ...
  set radio0_rfdc_clk_1x [ create_bd_port -dir O -type clk radio0_rfdc_clk_1x ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {adc_tile224_ch0_dout_i:adc_tile224_ch0_dout_q:dac_tile228_ch0_din:dac_tile229_ch0_din} \
   CONFIG.FREQ_HZ {320000000} \
 ] $radio0_rfdc_clk_1x
  set radio0_rfdc_clk_2x [ create_bd_port -dir O -type clk radio0_rfdc_clk_2x ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {640000000} \
 ] $radio0_rfdc_clk_2x
  ...
  set radio1_rfdc_clk_1x [ create_bd_port -dir O -type clk radio1_rfdc_clk_1x ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {adc_tile226_ch0_dout_i:adc_tile226_ch0_dout_q} \
   CONFIG.FREQ_HZ {320000000} \
 ] $radio1_rfdc_clk_1x
  set radio1_rfdc_clk_2x [ create_bd_port -dir O -type clk radio1_rfdc_clk_2x ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {640000000} \
 ] $radio1_rfdc_clk_2x
  ...
  set start_nco_reset_r0clk [ create_bd_port -dir I start_nco_reset_r0clk ]
  ...
  connect_bd_intf_net -intf_net rfdc_dac_tile228_ch2_vout [get_bd_intf_ports dac_tile228_ch3_vout] [get_bd_intf_pins rfdc/dac_tile228_ch3_vout]
  connect_bd_intf_net -intf_net rfdc_dac_tile229_ch2_vout [get_bd_intf_ports dac_tile229_ch3_vout] [get_bd_intf_pins rfdc/dac_tile229_ch3_vout]
  ...
  connect_bd_net -net adc_reset_pulse_r0clk_1 [get_bd_ports adc_reset_pulse_r0clk] [get_bd_pins rfdc/adc_reset_pulse_r0clk]
  connect_bd_net -net adc_reset_pulse_r1clk_1 [get_bd_ports adc_reset_pulse_r1clk] [get_bd_pins rfdc/adc_reset_pulse_r1clk]
  ...
  connect_bd_net -net dSysrefWaitCycles_0_1 [get_bd_ports sysref_wait_cycles] [get_bd_pins rfdc/sysref_wait_cycles]
  connect_bd_net -net dac_reset_pulse_r0clk_1 [get_bd_ports dac_reset_pulse_r0clk] [get_bd_pins rfdc/dac_reset_pulse_r0clk]
  connect_bd_net -net dac_reset_pulse_r1clk_1 [get_bd_ports dac_reset_pulse_r1clk] [get_bd_pins rfdc/dac_reset_pulse_r1clk]
  ...
  connect_bd_net -net enable_rclk_0_1 [get_bd_ports enable_sysref_r0clk] [get_bd_pins rfdc/enable_sysref_r0clk]
  ...
  connect_bd_net -net rStartNcoReset_0_1 [get_bd_ports start_nco_reset_r0clk] [get_bd_pins rfdc/start_nco_reset_r0clk]
  connect_bd_net -net rf_data_converter_irq [get_bd_ports rfdc_irq] [get_bd_pins rfdc/rfdc_irq]
  connect_bd_net -net rf_nco_reset_0_rNcoResetDone [get_bd_ports nco_reset_done_r0clk] [get_bd_pins rfdc/nco_reset_done_r0clk]
  connect_bd_net -net rf_rfdc_info_clk40_1 [get_bd_ports rf_rfdc_info_clk40] [get_bd_pins rfdc/rf_rfdc_info_sclk]
  connect_bd_net -net rfdc_adc_enable_data_r0clk [get_bd_ports adc_enable_data_r0clk] [get_bd_pins rfdc/adc_enable_data_r0clk]
  connect_bd_net -net rfdc_adc_enable_data_r1clk [get_bd_ports adc_enable_data_r1clk] [get_bd_pins rfdc/adc_enable_data_r1clk]
  ...
  connect_bd_net -net rfdc_dac_data_in_resetn_r1clk2x [get_bd_ports dac_data_in_resetn_r1clk2x] [get_bd_pins rfdc/dac_data_in_resetn_r1clk2x]
