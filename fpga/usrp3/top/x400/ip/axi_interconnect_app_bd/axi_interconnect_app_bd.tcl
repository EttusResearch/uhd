...
proc create_root_design { parentCell } {
  ...
  assign_bd_address -offset 0x001200000000 -range 0x00040000 -target_address_space [get_bd_addr_spaces s_axi_app] [get_bd_addr_segs m_axi_qsfp0/Reg] -force
  assign_bd_address -offset 0x001200040000 -range 0x00040000 -target_address_space [get_bd_addr_spaces s_axi_app] [get_bd_addr_segs m_axi_qsfp1/Reg] -force
