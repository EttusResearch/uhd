...
module rfnoc_image_core #(
  ...
  chdr_crossbar_nxn #(
    ...
    .device_id      (device_id),
    .s_axis_tdata   ({ep7_to_xb_tdata , ep6_to_xb_tdata , ep5_to_xb_tdata , ep4_to_xb_tdata , ep3_to_xb_tdata , ep2_to_xb_tdata , ep1_to_xb_tdata , ep0_to_xb_tdata , s_dma_tdata , {PORT_W{1'b0}}, s_eth3_tdata , s_eth2_tdata , s_eth1_tdata , s_eth0_tdata }),
    .s_axis_tlast   ({ep7_to_xb_tlast , ep6_to_xb_tlast , ep5_to_xb_tlast , ep4_to_xb_tlast , ep3_to_xb_tlast , ep2_to_xb_tlast , ep1_to_xb_tlast , ep0_to_xb_tlast , s_dma_tlast ,           1'b0, s_eth3_tlast , s_eth2_tlast , s_eth1_tlast , s_eth0_tlast }),
    .s_axis_tvalid  ({ep7_to_xb_tvalid, ep6_to_xb_tvalid, ep5_to_xb_tvalid, ep4_to_xb_tvalid, ep3_to_xb_tvalid, ep2_to_xb_tvalid, ep1_to_xb_tvalid, ep0_to_xb_tvalid, s_dma_tvalid,           1'b0, s_eth3_tvalid, s_eth2_tvalid, s_eth1_tvalid, s_eth0_tvalid}),
    .s_axis_tready  ({ep7_to_xb_tready, ep6_to_xb_tready, ep5_to_xb_tready, ep4_to_xb_tready, ep3_to_xb_tready, ep2_to_xb_tready, ep1_to_xb_tready, ep0_to_xb_tready, s_dma_tready,           1'bZ, s_eth3_tready, s_eth2_tready, s_eth1_tready, s_eth0_tready}),
    .m_axis_tdata   ({xb_to_ep7_tdata , xb_to_ep6_tdata , xb_to_ep5_tdata , xb_to_ep4_tdata , xb_to_ep3_tdata , xb_to_ep2_tdata , xb_to_ep1_tdata , xb_to_ep0_tdata , m_dma_tdata , {PORT_W{1'bZ}}, m_eth3_tdata , m_eth2_tdata , m_eth1_tdata , m_eth0_tdata }),
    .m_axis_tlast   ({xb_to_ep7_tlast , xb_to_ep6_tlast , xb_to_ep5_tlast , xb_to_ep4_tlast , xb_to_ep3_tlast , xb_to_ep2_tlast , xb_to_ep1_tlast , xb_to_ep0_tlast , m_dma_tlast ,           1'bZ, m_eth3_tlast , m_eth2_tlast , m_eth1_tlast , m_eth0_tlast }),
    .m_axis_tvalid  ({xb_to_ep7_tvalid, xb_to_ep6_tvalid, xb_to_ep5_tvalid, xb_to_ep4_tvalid, xb_to_ep3_tvalid, xb_to_ep2_tvalid, xb_to_ep1_tvalid, xb_to_ep0_tvalid, m_dma_tvalid,           1'bZ, m_eth3_tvalid, m_eth2_tvalid, m_eth1_tvalid, m_eth0_tvalid}),
    .m_axis_tready  ({xb_to_ep7_tready, xb_to_ep6_tready, xb_to_ep5_tready, xb_to_ep4_tready, xb_to_ep3_tready, xb_to_ep2_tready, xb_to_ep1_tready, xb_to_ep0_tready, m_dma_tready,           1'b1, m_eth3_tready, m_eth2_tready, m_eth1_tready, m_eth0_tready}),
    .ext_rtcfg_stb  (1'h0),
  ...
  // If requested buffer size is 0, use the minimum SRL-based FIFO size.
  // Otherwise, make sure it's at least two MTU-sized packets.
  localparam REQ_BUFF_SIZE_EP4 = 32768;
  ...
  // If requested buffer size is 0, use the minimum SRL-based FIFO size.
  // Otherwise, make sure it's at least two MTU-sized packets.
  localparam REQ_BUFF_SIZE_EP5 = 32768;
  ...
  // If requested buffer size is 0, use the minimum SRL-based FIFO size.
  // Otherwise, make sure it's at least two MTU-sized packets.
  localparam REQ_BUFF_SIZE_EP6 = 32768;
  ...
  // If requested buffer size is 0, use the minimum SRL-based FIFO size.
  // Otherwise, make sure it's at least two MTU-sized packets.
  localparam REQ_BUFF_SIZE_EP7 = 32768;
  ...
  axis_ctrl_crossbar_nxn #(
    ...
    .s_axis_tdata     ({m_ddc1_ctrl_tdata , m_duc1_ctrl_tdata , m_ddc0_ctrl_tdata , m_duc0_ctrl_tdata , m_radio1_ctrl_tdata , m_radio0_ctrl_tdata , m_ep0_ctrl_tdata , m_core_ctrl_tdata }),
    .s_axis_tvalid    ({m_ddc1_ctrl_tvalid, m_duc1_ctrl_tvalid, m_ddc0_ctrl_tvalid, m_duc0_ctrl_tvalid, m_radio1_ctrl_tvalid, m_radio0_ctrl_tvalid, m_ep0_ctrl_tvalid, m_core_ctrl_tvalid}),
    .s_axis_tlast     ({m_ddc1_ctrl_tlast , m_duc1_ctrl_tlast , m_ddc0_ctrl_tlast , m_duc0_ctrl_tlast , m_radio1_ctrl_tlast , m_radio0_ctrl_tlast , m_ep0_ctrl_tlast , m_core_ctrl_tlast }),
    .s_axis_tready    ({m_ddc1_ctrl_tready, m_duc1_ctrl_tready, m_ddc0_ctrl_tready, m_duc0_ctrl_tready, m_radio1_ctrl_tready, m_radio0_ctrl_tready, m_ep0_ctrl_tready, m_core_ctrl_tready}),
    .m_axis_tdata     ({s_ddc1_ctrl_tdata , s_duc1_ctrl_tdata , s_ddc0_ctrl_tdata , s_duc0_ctrl_tdata , s_radio1_ctrl_tdata , s_radio0_ctrl_tdata , s_ep0_ctrl_tdata , s_core_ctrl_tdata }),
    .m_axis_tvalid    ({s_ddc1_ctrl_tvalid, s_duc1_ctrl_tvalid, s_ddc0_ctrl_tvalid, s_duc0_ctrl_tvalid, s_radio1_ctrl_tvalid, s_radio0_ctrl_tvalid, s_ep0_ctrl_tvalid, s_core_ctrl_tvalid}),
    .m_axis_tlast     ({s_ddc1_ctrl_tlast , s_duc1_ctrl_tlast , s_ddc0_ctrl_tlast , s_duc0_ctrl_tlast , s_radio1_ctrl_tlast , s_radio0_ctrl_tlast , s_ep0_ctrl_tlast , s_core_ctrl_tlast }),
    .m_axis_tready    ({s_ddc1_ctrl_tready, s_duc1_ctrl_tready, s_ddc0_ctrl_tready, s_duc0_ctrl_tready, s_radio1_ctrl_tready, s_radio0_ctrl_tready, s_ep0_ctrl_tready, s_core_ctrl_tready}),
    .deadlock_detected()
  );
  ...
  wire                    duc0_ce_clk;
  wire [BLOCK_CHDR_W-1:0] s_duc0_in_3_tdata , s_duc0_in_2_tdata , s_duc0_in_1_tdata , s_duc0_in_0_tdata ;
  wire                    s_duc0_in_3_tlast , s_duc0_in_2_tlast , s_duc0_in_1_tlast , s_duc0_in_0_tlast ;
  wire                    s_duc0_in_3_tvalid, s_duc0_in_2_tvalid, s_duc0_in_1_tvalid, s_duc0_in_0_tvalid;
  wire                    s_duc0_in_3_tready, s_duc0_in_2_tready, s_duc0_in_1_tready, s_duc0_in_0_tready;
  wire [BLOCK_CHDR_W-1:0] m_duc0_out_3_tdata , m_duc0_out_2_tdata , m_duc0_out_1_tdata , m_duc0_out_0_tdata ;
  wire                    m_duc0_out_3_tlast , m_duc0_out_2_tlast , m_duc0_out_1_tlast , m_duc0_out_0_tlast ;
  wire                    m_duc0_out_3_tvalid, m_duc0_out_2_tvalid, m_duc0_out_1_tvalid, m_duc0_out_0_tvalid;
  wire                    m_duc0_out_3_tready, m_duc0_out_2_tready, m_duc0_out_1_tready, m_duc0_out_0_tready;
  ...
  rfnoc_block_duc #(
    ...
    .s_rfnoc_chdr_tdata  ({s_duc0_in_3_tdata , s_duc0_in_2_tdata , s_duc0_in_1_tdata , s_duc0_in_0_tdata }),
    .s_rfnoc_chdr_tlast  ({s_duc0_in_3_tlast , s_duc0_in_2_tlast , s_duc0_in_1_tlast , s_duc0_in_0_tlast }),
    .s_rfnoc_chdr_tvalid ({s_duc0_in_3_tvalid, s_duc0_in_2_tvalid, s_duc0_in_1_tvalid, s_duc0_in_0_tvalid}),
    .s_rfnoc_chdr_tready ({s_duc0_in_3_tready, s_duc0_in_2_tready, s_duc0_in_1_tready, s_duc0_in_0_tready}),
    .m_rfnoc_chdr_tdata  ({m_duc0_out_3_tdata , m_duc0_out_2_tdata , m_duc0_out_1_tdata , m_duc0_out_0_tdata }),
    .m_rfnoc_chdr_tlast  ({m_duc0_out_3_tlast , m_duc0_out_2_tlast , m_duc0_out_1_tlast , m_duc0_out_0_tlast }),
    .m_rfnoc_chdr_tvalid ({m_duc0_out_3_tvalid, m_duc0_out_2_tvalid, m_duc0_out_1_tvalid, m_duc0_out_0_tvalid}),
    .m_rfnoc_chdr_tready ({m_duc0_out_3_tready, m_duc0_out_2_tready, m_duc0_out_1_tready, m_duc0_out_0_tready}),
  ...
  wire                    ddc0_ce_clk;
  wire [BLOCK_CHDR_W-1:0] s_ddc0_in_3_tdata , s_ddc0_in_2_tdata , s_ddc0_in_1_tdata , s_ddc0_in_0_tdata ;
  wire                    s_ddc0_in_3_tlast , s_ddc0_in_2_tlast , s_ddc0_in_1_tlast , s_ddc0_in_0_tlast ;
  wire                    s_ddc0_in_3_tvalid, s_ddc0_in_2_tvalid, s_ddc0_in_1_tvalid, s_ddc0_in_0_tvalid;
  wire                    s_ddc0_in_3_tready, s_ddc0_in_2_tready, s_ddc0_in_1_tready, s_ddc0_in_0_tready;
  wire [BLOCK_CHDR_W-1:0] m_ddc0_out_3_tdata , m_ddc0_out_2_tdata , m_ddc0_out_1_tdata , m_ddc0_out_0_tdata ;
  wire                    m_ddc0_out_3_tlast , m_ddc0_out_2_tlast , m_ddc0_out_1_tlast , m_ddc0_out_0_tlast ;
  wire                    m_ddc0_out_3_tvalid, m_ddc0_out_2_tvalid, m_ddc0_out_1_tvalid, m_ddc0_out_0_tvalid;
  wire                    m_ddc0_out_3_tready, m_ddc0_out_2_tready, m_ddc0_out_1_tready, m_ddc0_out_0_tready;
  ...
  rfnoc_block_ddc #(
    ...
    .s_rfnoc_chdr_tdata  ({s_ddc0_in_3_tdata , s_ddc0_in_2_tdata , s_ddc0_in_1_tdata , s_ddc0_in_0_tdata }),
    .s_rfnoc_chdr_tlast  ({s_ddc0_in_3_tlast , s_ddc0_in_2_tlast , s_ddc0_in_1_tlast , s_ddc0_in_0_tlast }),
    .s_rfnoc_chdr_tvalid ({s_ddc0_in_3_tvalid, s_ddc0_in_2_tvalid, s_ddc0_in_1_tvalid, s_ddc0_in_0_tvalid}),
    .s_rfnoc_chdr_tready ({s_ddc0_in_3_tready, s_ddc0_in_2_tready, s_ddc0_in_1_tready, s_ddc0_in_0_tready}),
    .m_rfnoc_chdr_tdata  ({m_ddc0_out_3_tdata , m_ddc0_out_2_tdata , m_ddc0_out_1_tdata , m_ddc0_out_0_tdata }),
    .m_rfnoc_chdr_tlast  ({m_ddc0_out_3_tlast , m_ddc0_out_2_tlast , m_ddc0_out_1_tlast , m_ddc0_out_0_tlast }),
    .m_rfnoc_chdr_tvalid ({m_ddc0_out_3_tvalid, m_ddc0_out_2_tvalid, m_ddc0_out_1_tvalid, m_ddc0_out_0_tvalid}),
    .m_rfnoc_chdr_tready ({m_ddc0_out_3_tready, m_ddc0_out_2_tready, m_ddc0_out_1_tready, m_ddc0_out_0_tready}),
  ...
  wire                    duc1_ce_clk;
  wire [BLOCK_CHDR_W-1:0] s_duc1_in_3_tdata , s_duc1_in_2_tdata , s_duc1_in_1_tdata , s_duc1_in_0_tdata ;
  wire                    s_duc1_in_3_tlast , s_duc1_in_2_tlast , s_duc1_in_1_tlast , s_duc1_in_0_tlast ;
  wire                    s_duc1_in_3_tvalid, s_duc1_in_2_tvalid, s_duc1_in_1_tvalid, s_duc1_in_0_tvalid;
  wire                    s_duc1_in_3_tready, s_duc1_in_2_tready, s_duc1_in_1_tready, s_duc1_in_0_tready;
  wire [BLOCK_CHDR_W-1:0] m_duc1_out_3_tdata , m_duc1_out_2_tdata , m_duc1_out_1_tdata , m_duc1_out_0_tdata ;
  wire                    m_duc1_out_3_tlast , m_duc1_out_2_tlast , m_duc1_out_1_tlast , m_duc1_out_0_tlast ;
  wire                    m_duc1_out_3_tvalid, m_duc1_out_2_tvalid, m_duc1_out_1_tvalid, m_duc1_out_0_tvalid;
  wire                    m_duc1_out_3_tready, m_duc1_out_2_tready, m_duc1_out_1_tready, m_duc1_out_0_tready;
  ...
  rfnoc_block_duc #(
    ...
    .s_rfnoc_chdr_tdata  ({s_duc1_in_3_tdata , s_duc1_in_2_tdata , s_duc1_in_1_tdata , s_duc1_in_0_tdata }),
    .s_rfnoc_chdr_tlast  ({s_duc1_in_3_tlast , s_duc1_in_2_tlast , s_duc1_in_1_tlast , s_duc1_in_0_tlast }),
    .s_rfnoc_chdr_tvalid ({s_duc1_in_3_tvalid, s_duc1_in_2_tvalid, s_duc1_in_1_tvalid, s_duc1_in_0_tvalid}),
    .s_rfnoc_chdr_tready ({s_duc1_in_3_tready, s_duc1_in_2_tready, s_duc1_in_1_tready, s_duc1_in_0_tready}),
    .m_rfnoc_chdr_tdata  ({m_duc1_out_3_tdata , m_duc1_out_2_tdata , m_duc1_out_1_tdata , m_duc1_out_0_tdata }),
    .m_rfnoc_chdr_tlast  ({m_duc1_out_3_tlast , m_duc1_out_2_tlast , m_duc1_out_1_tlast , m_duc1_out_0_tlast }),
    .m_rfnoc_chdr_tvalid ({m_duc1_out_3_tvalid, m_duc1_out_2_tvalid, m_duc1_out_1_tvalid, m_duc1_out_0_tvalid}),
    .m_rfnoc_chdr_tready ({m_duc1_out_3_tready, m_duc1_out_2_tready, m_duc1_out_1_tready, m_duc1_out_0_tready}),
  ...
  wire                    ddc1_ce_clk;
  wire [BLOCK_CHDR_W-1:0] s_ddc1_in_3_tdata , s_ddc1_in_2_tdata , s_ddc1_in_1_tdata , s_ddc1_in_0_tdata ;
  wire                    s_ddc1_in_3_tlast , s_ddc1_in_2_tlast , s_ddc1_in_1_tlast , s_ddc1_in_0_tlast ;
  wire                    s_ddc1_in_3_tvalid, s_ddc1_in_2_tvalid, s_ddc1_in_1_tvalid, s_ddc1_in_0_tvalid;
  wire                    s_ddc1_in_3_tready, s_ddc1_in_2_tready, s_ddc1_in_1_tready, s_ddc1_in_0_tready;
  wire [BLOCK_CHDR_W-1:0] m_ddc1_out_3_tdata , m_ddc1_out_2_tdata , m_ddc1_out_1_tdata , m_ddc1_out_0_tdata ;
  wire                    m_ddc1_out_3_tlast , m_ddc1_out_2_tlast , m_ddc1_out_1_tlast , m_ddc1_out_0_tlast ;
  wire                    m_ddc1_out_3_tvalid, m_ddc1_out_2_tvalid, m_ddc1_out_1_tvalid, m_ddc1_out_0_tvalid;
  wire                    m_ddc1_out_3_tready, m_ddc1_out_2_tready, m_ddc1_out_1_tready, m_ddc1_out_0_tready;
  ...
  rfnoc_block_ddc #(
    ...
    .s_rfnoc_chdr_tdata  ({s_ddc1_in_3_tdata , s_ddc1_in_2_tdata , s_ddc1_in_1_tdata , s_ddc1_in_0_tdata }),
    .s_rfnoc_chdr_tlast  ({s_ddc1_in_3_tlast , s_ddc1_in_2_tlast , s_ddc1_in_1_tlast , s_ddc1_in_0_tlast }),
    .s_rfnoc_chdr_tvalid ({s_ddc1_in_3_tvalid, s_ddc1_in_2_tvalid, s_ddc1_in_1_tvalid, s_ddc1_in_0_tvalid}),
    .s_rfnoc_chdr_tready ({s_ddc1_in_3_tready, s_ddc1_in_2_tready, s_ddc1_in_1_tready, s_ddc1_in_0_tready}),
    .m_rfnoc_chdr_tdata  ({m_ddc1_out_3_tdata , m_ddc1_out_2_tdata , m_ddc1_out_1_tdata , m_ddc1_out_0_tdata }),
    .m_rfnoc_chdr_tlast  ({m_ddc1_out_3_tlast , m_ddc1_out_2_tlast , m_ddc1_out_1_tlast , m_ddc1_out_0_tlast }),
    .m_rfnoc_chdr_tvalid ({m_ddc1_out_3_tvalid, m_ddc1_out_2_tvalid, m_ddc1_out_1_tvalid, m_ddc1_out_0_tvalid}),
    .m_rfnoc_chdr_tready ({m_ddc1_out_3_tready, m_ddc1_out_2_tready, m_ddc1_out_1_tready, m_ddc1_out_0_tready}),
  ...
  assign s_duc0_in_2_tdata = m_ep2_out0_tdata;
  assign s_duc0_in_2_tlast = m_ep2_out0_tlast;
  assign s_duc0_in_2_tvalid = m_ep2_out0_tvalid;
  assign m_ep2_out0_tready = s_duc0_in_2_tready;

  assign s_radio0_in_2_tdata = m_duc0_out_2_tdata;
  assign s_radio0_in_2_tlast = m_duc0_out_2_tlast;
  assign s_radio0_in_2_tvalid = m_duc0_out_2_tvalid;
  assign m_duc0_out_2_tready = s_radio0_in_2_tready;

  assign s_ddc0_in_2_tdata = m_radio0_out_2_tdata;
  assign s_ddc0_in_2_tlast = m_radio0_out_2_tlast;
  assign s_ddc0_in_2_tvalid = m_radio0_out_2_tvalid;
  assign m_radio0_out_2_tready = s_ddc0_in_2_tready;

  assign s_ep2_in0_tdata = m_ddc0_out_2_tdata;
  assign s_ep2_in0_tlast = m_ddc0_out_2_tlast;
  assign s_ep2_in0_tvalid = m_ddc0_out_2_tvalid;
  assign m_ddc0_out_2_tready = s_ep2_in0_tready;

  assign s_duc0_in_3_tdata = m_ep3_out0_tdata;
  assign s_duc0_in_3_tlast = m_ep3_out0_tlast;
  assign s_duc0_in_3_tvalid = m_ep3_out0_tvalid;
  assign m_ep3_out0_tready = s_duc0_in_3_tready;

  assign s_radio0_in_3_tdata = m_duc0_out_3_tdata;
  assign s_radio0_in_3_tlast = m_duc0_out_3_tlast;
  assign s_radio0_in_3_tvalid = m_duc0_out_3_tvalid;
  assign m_duc0_out_3_tready = s_radio0_in_3_tready;

  assign s_ddc0_in_3_tdata = m_radio0_out_3_tdata;
  assign s_ddc0_in_3_tlast = m_radio0_out_3_tlast;
  assign s_ddc0_in_3_tvalid = m_radio0_out_3_tvalid;
  assign m_radio0_out_3_tready = s_ddc0_in_3_tready;

  assign s_ep3_in0_tdata = m_ddc0_out_3_tdata;
  assign s_ep3_in0_tlast = m_ddc0_out_3_tlast;
  assign s_ep3_in0_tvalid = m_ddc0_out_3_tvalid;
  assign m_ddc0_out_3_tready = s_ep3_in0_tready;

  assign s_duc1_in_0_tdata = m_ep4_out0_tdata;
  assign s_duc1_in_0_tlast = m_ep4_out0_tlast;
  assign s_duc1_in_0_tvalid = m_ep4_out0_tvalid;
  assign m_ep4_out0_tready = s_duc1_in_0_tready;
  ...
  assign s_ep4_in0_tdata = m_ddc1_out_0_tdata;
  assign s_ep4_in0_tlast = m_ddc1_out_0_tlast;
  assign s_ep4_in0_tvalid = m_ddc1_out_0_tvalid;
  assign m_ddc1_out_0_tready = s_ep4_in0_tready;

  assign s_duc1_in_1_tdata = m_ep5_out0_tdata;
  assign s_duc1_in_1_tlast = m_ep5_out0_tlast;
  assign s_duc1_in_1_tvalid = m_ep5_out0_tvalid;
  assign m_ep5_out0_tready = s_duc1_in_1_tready;
  ...
  assign s_ep5_in0_tdata = m_ddc1_out_1_tdata;
  assign s_ep5_in0_tlast = m_ddc1_out_1_tlast;
  assign s_ep5_in0_tvalid = m_ddc1_out_1_tvalid;
  assign m_ddc1_out_1_tready = s_ep5_in0_tready;

  assign s_duc1_in_2_tdata = m_ep6_out0_tdata;
  assign s_duc1_in_2_tlast = m_ep6_out0_tlast;
  assign s_duc1_in_2_tvalid = m_ep6_out0_tvalid;
  assign m_ep6_out0_tready = s_duc1_in_2_tready;

  assign s_radio1_in_2_tdata = m_duc1_out_2_tdata;
  assign s_radio1_in_2_tlast = m_duc1_out_2_tlast;
  assign s_radio1_in_2_tvalid = m_duc1_out_2_tvalid;
  assign m_duc1_out_2_tready = s_radio1_in_2_tready;

  assign s_ddc1_in_2_tdata = m_radio1_out_2_tdata;
  assign s_ddc1_in_2_tlast = m_radio1_out_2_tlast;
  assign s_ddc1_in_2_tvalid = m_radio1_out_2_tvalid;
  assign m_radio1_out_2_tready = s_ddc1_in_2_tready;

  assign s_ep6_in0_tdata = m_ddc1_out_2_tdata;
  assign s_ep6_in0_tlast = m_ddc1_out_2_tlast;
  assign s_ep6_in0_tvalid = m_ddc1_out_2_tvalid;
  assign m_ddc1_out_2_tready = s_ep6_in0_tready;

  assign s_duc1_in_3_tdata = m_ep7_out0_tdata;
  assign s_duc1_in_3_tlast = m_ep7_out0_tlast;
  assign s_duc1_in_3_tvalid = m_ep7_out0_tvalid;
  assign m_ep7_out0_tready = s_duc1_in_3_tready;

  assign s_radio1_in_3_tdata = m_duc1_out_3_tdata;
  assign s_radio1_in_3_tlast = m_duc1_out_3_tlast;
  assign s_radio1_in_3_tvalid = m_duc1_out_3_tvalid;
  assign m_duc1_out_3_tready = s_radio1_in_3_tready;

  assign s_ddc1_in_3_tdata = m_radio1_out_3_tdata;
  assign s_ddc1_in_3_tlast = m_radio1_out_3_tlast;
  assign s_ddc1_in_3_tvalid = m_radio1_out_3_tvalid;
  assign m_radio1_out_3_tready = s_ddc1_in_3_tready;

  assign s_ep7_in0_tdata = m_ddc1_out_3_tdata;
  assign s_ep7_in0_tlast = m_ddc1_out_3_tlast;
  assign s_ep7_in0_tvalid = m_ddc1_out_3_tvalid;
  assign m_ddc1_out_3_tready = s_ep7_in0_tready;
