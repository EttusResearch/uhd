...
set_property PACKAGE_PIN L2  [get_ports {DB0_TX_P[2]}]
set_property PACKAGE_PIN L1  [get_ports {DB0_TX_N[2]}]
...
set_property PACKAGE_PIN C2  [get_ports {DB1_TX_P[2]}]
set_property PACKAGE_PIN C1  [get_ports {DB1_TX_N[2]}]
