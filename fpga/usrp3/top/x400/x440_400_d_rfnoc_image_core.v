...
module rfnoc_image_core #(
  ...
  wire [BLOCK_CHDR_W-1:0] s_replay1_in_3_tdata , s_replay1_in_2_tdata , s_replay1_in_1_tdata , s_replay1_in_0_tdata ;
  wire                    s_replay1_in_3_tlast , s_replay1_in_2_tlast , s_replay1_in_1_tlast , s_replay1_in_0_tlast ;
  wire                    s_replay1_in_3_tvalid, s_replay1_in_2_tvalid, s_replay1_in_1_tvalid, s_replay1_in_0_tvalid;
  wire                    s_replay1_in_3_tready, s_replay1_in_2_tready, s_replay1_in_1_tready, s_replay1_in_0_tready;
  wire [BLOCK_CHDR_W-1:0] m_replay1_out_3_tdata , m_replay1_out_2_tdata , m_replay1_out_1_tdata , m_replay1_out_0_tdata ;
  wire                    m_replay1_out_3_tlast , m_replay1_out_2_tlast , m_replay1_out_1_tlast , m_replay1_out_0_tlast ;
  wire                    m_replay1_out_3_tvalid, m_replay1_out_2_tvalid, m_replay1_out_1_tvalid, m_replay1_out_0_tvalid;
  wire                    m_replay1_out_3_tready, m_replay1_out_2_tready, m_replay1_out_1_tready, m_replay1_out_0_tready;
  ...
  rfnoc_block_replay #(
    ...
    .s_rfnoc_chdr_tdata  ({s_replay1_in_3_tdata , s_replay1_in_2_tdata , s_replay1_in_1_tdata , s_replay1_in_0_tdata }),
    .s_rfnoc_chdr_tlast  ({s_replay1_in_3_tlast , s_replay1_in_2_tlast , s_replay1_in_1_tlast , s_replay1_in_0_tlast }),
    .s_rfnoc_chdr_tvalid ({s_replay1_in_3_tvalid, s_replay1_in_2_tvalid, s_replay1_in_1_tvalid, s_replay1_in_0_tvalid}),
    .s_rfnoc_chdr_tready ({s_replay1_in_3_tready, s_replay1_in_2_tready, s_replay1_in_1_tready, s_replay1_in_0_tready}),
    .m_rfnoc_chdr_tdata  ({m_replay1_out_3_tdata , m_replay1_out_2_tdata , m_replay1_out_1_tdata , m_replay1_out_0_tdata }),
    .m_rfnoc_chdr_tlast  ({m_replay1_out_3_tlast , m_replay1_out_2_tlast , m_replay1_out_1_tlast , m_replay1_out_0_tlast }),
    .m_rfnoc_chdr_tvalid ({m_replay1_out_3_tvalid, m_replay1_out_2_tvalid, m_replay1_out_1_tvalid, m_replay1_out_0_tvalid}),
    .m_rfnoc_chdr_tready ({m_replay1_out_3_tready, m_replay1_out_2_tready, m_replay1_out_1_tready, m_replay1_out_0_tready}),
  ...
  assign s_replay1_in_0_tdata = m_ep12_out0_tdata;
  assign s_replay1_in_0_tlast = m_ep12_out0_tlast;
  assign s_replay1_in_0_tvalid = m_ep12_out0_tvalid;
  assign m_ep12_out0_tready = s_replay1_in_0_tready;

  assign s_ep12_in0_tdata = m_replay1_out_0_tdata;
  assign s_ep12_in0_tlast = m_replay1_out_0_tlast;
  assign s_ep12_in0_tvalid = m_replay1_out_0_tvalid;
  assign m_replay1_out_0_tready = s_ep12_in0_tready;

  assign s_replay1_in_1_tdata = m_ep13_out0_tdata;
  assign s_replay1_in_1_tlast = m_ep13_out0_tlast;
  assign s_replay1_in_1_tvalid = m_ep13_out0_tvalid;
  assign m_ep13_out0_tready = s_replay1_in_1_tready;

  assign s_ep13_in0_tdata = m_replay1_out_1_tdata;
  assign s_ep13_in0_tlast = m_replay1_out_1_tlast;
  assign s_ep13_in0_tvalid = m_replay1_out_1_tvalid;
  assign m_replay1_out_1_tready = s_ep13_in0_tready;

  assign s_replay1_in_2_tdata = m_ep14_out0_tdata;
  assign s_replay1_in_2_tlast = m_ep14_out0_tlast;
  assign s_replay1_in_2_tvalid = m_ep14_out0_tvalid;
  assign m_ep14_out0_tready = s_replay1_in_2_tready;

  assign s_ep14_in0_tdata = m_replay1_out_2_tdata;
  assign s_ep14_in0_tlast = m_replay1_out_2_tlast;
  assign s_ep14_in0_tvalid = m_replay1_out_2_tvalid;
  assign m_replay1_out_2_tready = s_ep14_in0_tready;

  assign s_replay1_in_3_tdata = m_ep15_out0_tdata;
  assign s_replay1_in_3_tlast = m_ep15_out0_tlast;
  assign s_replay1_in_3_tvalid = m_ep15_out0_tvalid;
  assign m_ep15_out0_tready = s_replay1_in_3_tready;

  assign s_ep15_in0_tdata = m_replay1_out_3_tdata;
  assign s_ep15_in0_tlast = m_replay1_out_3_tlast;
  assign s_ep15_in0_tvalid = m_replay1_out_3_tvalid;
  assign m_replay1_out_3_tready = s_ep15_in0_tready;
