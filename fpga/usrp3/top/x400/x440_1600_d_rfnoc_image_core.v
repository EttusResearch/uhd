...
module rfnoc_image_core #(
  ...
  wire [BLOCK_CHDR_W-1:0] s_replay0_in_0_tdata ;
  wire                    s_replay0_in_0_tlast ;
  wire                    s_replay0_in_0_tvalid;
  wire                    s_replay0_in_0_tready;
  wire [BLOCK_CHDR_W-1:0] m_replay0_out_0_tdata ;
  wire                    m_replay0_out_0_tlast ;
  wire                    m_replay0_out_0_tvalid;
  wire                    m_replay0_out_0_tready;
  ...
  rfnoc_block_replay #(
    ...
    .s_rfnoc_chdr_tdata  ({s_replay0_in_0_tdata }),
    .s_rfnoc_chdr_tlast  ({s_replay0_in_0_tlast }),
    .s_rfnoc_chdr_tvalid ({s_replay0_in_0_tvalid}),
    .s_rfnoc_chdr_tready ({s_replay0_in_0_tready}),
    .m_rfnoc_chdr_tdata  ({m_replay0_out_0_tdata }),
    .m_rfnoc_chdr_tlast  ({m_replay0_out_0_tlast }),
    .m_rfnoc_chdr_tvalid ({m_replay0_out_0_tvalid}),
    .m_rfnoc_chdr_tready ({m_replay0_out_0_tready}),
  ...
  wire [BLOCK_CHDR_W-1:0] s_replay1_in_0_tdata ;
  wire                    s_replay1_in_0_tlast ;
  wire                    s_replay1_in_0_tvalid;
  wire                    s_replay1_in_0_tready;
  wire [BLOCK_CHDR_W-1:0] m_replay1_out_0_tdata ;
  wire                    m_replay1_out_0_tlast ;
  wire                    m_replay1_out_0_tvalid;
  wire                    m_replay1_out_0_tready;
  ...
  rfnoc_block_replay #(
    ...
    .s_rfnoc_chdr_tdata  ({s_replay1_in_0_tdata }),
    .s_rfnoc_chdr_tlast  ({s_replay1_in_0_tlast }),
    .s_rfnoc_chdr_tvalid ({s_replay1_in_0_tvalid}),
    .s_rfnoc_chdr_tready ({s_replay1_in_0_tready}),
    .m_rfnoc_chdr_tdata  ({m_replay1_out_0_tdata }),
    .m_rfnoc_chdr_tlast  ({m_replay1_out_0_tlast }),
    .m_rfnoc_chdr_tvalid ({m_replay1_out_0_tvalid}),
    .m_rfnoc_chdr_tready ({m_replay1_out_0_tready}),
  ...
  assign s_replay1_in_0_tdata = m_ep3_out0_tdata;
  assign s_replay1_in_0_tlast = m_ep3_out0_tlast;
  assign s_replay1_in_0_tvalid = m_ep3_out0_tvalid;
  assign m_ep3_out0_tready = s_replay1_in_0_tready;

  assign s_ep3_in0_tdata = m_replay1_out_0_tdata;
  assign s_ep3_in0_tlast = m_replay1_out_0_tlast;
  assign s_ep3_in0_tvalid = m_replay1_out_0_tvalid;
  assign m_replay1_out_0_tready = s_ep3_in0_tready;
