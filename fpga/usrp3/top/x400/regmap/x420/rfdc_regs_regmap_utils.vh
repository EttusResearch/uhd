...
//===============================================================================
  ...
  // MMCM                  : 0x0 (x420_rfdc_regs.v)
  // INVERT_DB0_IQ_REG     : 0x10000 (x420_rfdc_regs.v)
  // INVERT_DB1_IQ_REG     : 0x10800 (x420_rfdc_regs.v)
  // MMCM_RESET_REG        : 0x11000 (x420_rfdc_regs.v)
  // RF0_RESET_CONTROL_REG : 0x12000 (x420_rfdc_regs.v)
  // RF0_RESET_STATUS_REG  : 0x12008 (x420_rfdc_regs.v)
  // RF1_RESET_CONTROL_REG : 0x12800 (x420_rfdc_regs.v)
  // RF1_RESET_STATUS_REG  : 0x12808 (x420_rfdc_regs.v)
  // RF_AXI_STATUS_REG     : 0x13000 (x420_rfdc_regs.v)
  // FABRIC_DSP_REG        : 0x13008 (x420_rfdc_regs.v)
  // CALIBRATION_DATA      : 0x14000 (x420_rfdc_regs.v)
  // CALIBRATION_ENABLE    : 0x14008 (x420_rfdc_regs.v)
  // THRESHOLD_STATUS      : 0x15000 (x420_rfdc_regs.v)
  // RF_PLL_CONTROL_REG    : 0x16000 (x420_rfdc_regs.v)
  // RF_PLL_STATUS_REG     : 0x16008 (x420_rfdc_regs.v)
  // RFDC_INFO_MEM         : 0x17000 (x420_rfdc_regs.v)
  // RFDC_INFO_REG         : 0x18000 (x420_rfdc_regs.v)
...
//===============================================================================
  ...
  localparam RFDC_INFO_REGTYPE_MASK = 32'h3FF83FF;
  ...
  localparam RFDC_CLK_DIV4_ENABLE_SIZE =  1;  //RFDC_INFO_REGTYPE:RFDC_CLK_DIV4_ENABLE
  localparam RFDC_CLK_DIV4_ENABLE_MSB  = 15;  //RFDC_INFO_REGTYPE:RFDC_CLK_DIV4_ENABLE
  localparam RFDC_CLK_DIV4_ENABLE      = 15;  //RFDC_INFO_REGTYPE:RFDC_CLK_DIV4_ENABLE
...
//===============================================================================
  ...
  // MMCM Window (from x420_rfdc_regs.v)
  localparam MMCM = 'h0; // Window Offset
  localparam MMCM_SIZE = 'h10000;  // size in bytes

  // INVERT_DB0_IQ_REG Register (from x420_rfdc_regs.v)
  ...
  // INVERT_DB1_IQ_REG Register (from x420_rfdc_regs.v)
  ...
  // MMCM_RESET_REG Register (from x420_rfdc_regs.v)
  ...
  // CALIBRATION_ENABLE Register (from x420_rfdc_regs.v)
  ...
  // THRESHOLD_STATUS Register (from x420_rfdc_regs.v)
  ...
  // RF_PLL_CONTROL_REG Register (from x420_rfdc_regs.v)
  ...
  // RF_PLL_STATUS_REG Register (from x420_rfdc_regs.v)
  ...
  // RFDC_INFO_MEM Register (from x420_rfdc_regs.v)
  localparam RFDC_INFO_MEM_COUNT = 16; // Number of elements in array

  // RFDC_INFO_REG Register (from x420_rfdc_regs.v)
