...
//===============================================================================
  ...
  // Enumerated type RF_CORE_200M_VERSION
  localparam RF_CORE_200M_VERSION_SIZE = 7;
  localparam RF_CORE_200M_CURRENT_VERSION_MINOR            = 'h0;  // RF_CORE_200M_VERSION:RF_CORE_200M_CURRENT_VERSION_MINOR
  localparam RF_CORE_200M_CURRENT_VERSION_BUILD            = 'h0;  // RF_CORE_200M_VERSION:RF_CORE_200M_CURRENT_VERSION_BUILD
  localparam RF_CORE_200M_OLDEST_COMPATIBLE_VERSION_MINOR  = 'h0;  // RF_CORE_200M_VERSION:RF_CORE_200M_OLDEST_COMPATIBLE_VERSION_MINOR
  localparam RF_CORE_200M_OLDEST_COMPATIBLE_VERSION_BUILD  = 'h0;  // RF_CORE_200M_VERSION:RF_CORE_200M_OLDEST_COMPATIBLE_VERSION_BUILD
  localparam RF_CORE_200M_CURRENT_VERSION_MAJOR            = 'h1;  // RF_CORE_200M_VERSION:RF_CORE_200M_CURRENT_VERSION_MAJOR
  localparam RF_CORE_200M_OLDEST_COMPATIBLE_VERSION_MAJOR  = 'h1;  // RF_CORE_200M_VERSION:RF_CORE_200M_OLDEST_COMPATIBLE_VERSION_MAJOR
  localparam RF_CORE_200M_VERSION_LAST_MODIFIED_TIME       = 'h26052017;  // RF_CORE_200M_VERSION:RF_CORE_200M_VERSION_LAST_MODIFIED_TIME
