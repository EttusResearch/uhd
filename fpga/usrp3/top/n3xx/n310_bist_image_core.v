...
// File generated on: 2019-11-08T15:58:14.371732
// Source: ./n3xx/n310_bist_image_core.yml
// Source SHA256: 1a9ffb97d9678e700ad2aa172d206b6be9af30c7c0b014c21007d1de028a59d4
...
//  dram
  ...
  chdr_crossbar_nxn #(
    ...
    .device_id      (device_id),
    .s_axis_tdata   ({ep5_to_xb_tdata, ep4_to_xb_tdata, ep3_to_xb_tdata, ep2_to_xb_tdata, ep1_to_xb_tdata, ep0_to_xb_tdata, s_dma_tdata, s_eth1_tdata, s_eth0_tdata}),
    .s_axis_tlast   ({ep5_to_xb_tlast, ep4_to_xb_tlast, ep3_to_xb_tlast, ep2_to_xb_tlast, ep1_to_xb_tlast, ep0_to_xb_tlast, s_dma_tlast, s_eth1_tlast, s_eth0_tlast}),
    .s_axis_tvalid  ({ep5_to_xb_tvalid, ep4_to_xb_tvalid, ep3_to_xb_tvalid, ep2_to_xb_tvalid, ep1_to_xb_tvalid, ep0_to_xb_tvalid, s_dma_tvalid, s_eth1_tvalid, s_eth0_tvalid}),
    .s_axis_tready  ({ep5_to_xb_tready, ep4_to_xb_tready, ep3_to_xb_tready, ep2_to_xb_tready, ep1_to_xb_tready, ep0_to_xb_tready, s_dma_tready, s_eth1_tready, s_eth0_tready}),
    .m_axis_tdata   ({xb_to_ep5_tdata, xb_to_ep4_tdata, xb_to_ep3_tdata, xb_to_ep2_tdata, xb_to_ep1_tdata, xb_to_ep0_tdata, m_dma_tdata, m_eth1_tdata, m_eth0_tdata}),
    .m_axis_tlast   ({xb_to_ep5_tlast, xb_to_ep4_tlast, xb_to_ep3_tlast, xb_to_ep2_tlast, xb_to_ep1_tlast, xb_to_ep0_tlast, m_dma_tlast, m_eth1_tlast, m_eth0_tlast}),
    .m_axis_tvalid  ({xb_to_ep5_tvalid, xb_to_ep4_tvalid, xb_to_ep3_tvalid, xb_to_ep2_tvalid, xb_to_ep1_tvalid, xb_to_ep0_tvalid, m_dma_tvalid, m_eth1_tvalid, m_eth0_tvalid}),
    .m_axis_tready  ({xb_to_ep5_tready, xb_to_ep4_tready, xb_to_ep3_tready, xb_to_ep2_tready, xb_to_ep1_tready, xb_to_ep0_tready, m_dma_tready, m_eth1_tready, m_eth0_tready}),
    .ext_rtcfg_stb  (1'h0),
  ...
  axis_ctrl_crossbar_nxn #(
    ...
    .s_axis_tdata     ({m_fifo0_ctrl_tdata , m_radio1_ctrl_tdata , m_radio0_ctrl_tdata , m_ep0_ctrl_tdata , m_core_ctrl_tdata }),
    .s_axis_tvalid    ({m_fifo0_ctrl_tvalid, m_radio1_ctrl_tvalid, m_radio0_ctrl_tvalid, m_ep0_ctrl_tvalid, m_core_ctrl_tvalid}),
    .s_axis_tlast     ({m_fifo0_ctrl_tlast , m_radio1_ctrl_tlast , m_radio0_ctrl_tlast , m_ep0_ctrl_tlast , m_core_ctrl_tlast }),
    .s_axis_tready    ({m_fifo0_ctrl_tready, m_radio1_ctrl_tready, m_radio0_ctrl_tready, m_ep0_ctrl_tready, m_core_ctrl_tready}),
    .m_axis_tdata     ({s_fifo0_ctrl_tdata , s_radio1_ctrl_tdata , s_radio0_ctrl_tdata , s_ep0_ctrl_tdata , s_core_ctrl_tdata }),
    .m_axis_tvalid    ({s_fifo0_ctrl_tvalid, s_radio1_ctrl_tvalid, s_radio0_ctrl_tvalid, s_ep0_ctrl_tvalid, s_core_ctrl_tvalid}),
    .m_axis_tlast     ({s_fifo0_ctrl_tlast , s_radio1_ctrl_tlast , s_radio0_ctrl_tlast , s_ep0_ctrl_tlast , s_core_ctrl_tlast }),
    .m_axis_tready    ({s_fifo0_ctrl_tready, s_radio1_ctrl_tready, s_radio0_ctrl_tready, s_ep0_ctrl_tready, s_core_ctrl_tready}),
    .deadlock_detected()
  );
  ...
  wire [  4-1:0] fifo0_m_axi_awid;
  wire [128-1:0] fifo0_m_axi_awaddr;
  wire [ 32-1:0] fifo0_m_axi_awlen;
  wire [ 12-1:0] fifo0_m_axi_awsize;
  wire [  8-1:0] fifo0_m_axi_awburst;
  wire [  4-1:0] fifo0_m_axi_awlock;
  wire [ 16-1:0] fifo0_m_axi_awcache;
  wire [ 12-1:0] fifo0_m_axi_awprot;
  wire [ 16-1:0] fifo0_m_axi_awqos;
  wire [ 16-1:0] fifo0_m_axi_awregion;
  wire [  4-1:0] fifo0_m_axi_awuser;
  wire [  4-1:0] fifo0_m_axi_awvalid;
  wire [  4-1:0] fifo0_m_axi_awready;
  wire [256-1:0] fifo0_m_axi_wdata;
  wire [ 32-1:0] fifo0_m_axi_wstrb;
  wire [  4-1:0] fifo0_m_axi_wlast;
  wire [  4-1:0] fifo0_m_axi_wuser;
  wire [  4-1:0] fifo0_m_axi_wvalid;
  wire [  4-1:0] fifo0_m_axi_wready;
  wire [  4-1:0] fifo0_m_axi_bid;
  wire [  8-1:0] fifo0_m_axi_bresp;
  wire [  4-1:0] fifo0_m_axi_buser;
  wire [  4-1:0] fifo0_m_axi_bvalid;
  wire [  4-1:0] fifo0_m_axi_bready;
  wire [  4-1:0] fifo0_m_axi_arid;
  wire [128-1:0] fifo0_m_axi_araddr;
  wire [ 32-1:0] fifo0_m_axi_arlen;
  wire [ 12-1:0] fifo0_m_axi_arsize;
  wire [  8-1:0] fifo0_m_axi_arburst;
  wire [  4-1:0] fifo0_m_axi_arlock;
  wire [ 16-1:0] fifo0_m_axi_arcache;
  wire [ 12-1:0] fifo0_m_axi_arprot;
  wire [ 16-1:0] fifo0_m_axi_arqos;
  wire [ 16-1:0] fifo0_m_axi_arregion;
  wire [  4-1:0] fifo0_m_axi_aruser;
  wire [  4-1:0] fifo0_m_axi_arvalid;
  wire [  4-1:0] fifo0_m_axi_arready;
  wire [  4-1:0] fifo0_m_axi_rid;
  wire [256-1:0] fifo0_m_axi_rdata;
  wire [  8-1:0] fifo0_m_axi_rresp;
  wire [  4-1:0] fifo0_m_axi_rlast;
  wire [  4-1:0] fifo0_m_axi_ruser;
  wire [  4-1:0] fifo0_m_axi_rvalid;
  wire [  4-1:0] fifo0_m_axi_rready;
