...
module rfnoc_image_core #(
  ...
  chdr_crossbar_nxn #(
    .PORT_W         (PORT_W),
    .NPORTS         (7),
    .CHDR_WIDTHS    ({EP3_W, EP2_W, EP1_W, EP0_W, DMA_W, ETH1_W, ETH0_W}),
    .DEFAULT_PORT   (0),
    .ROUTES         ({ 7'b1111111,
                       7'b1111111,
                       7'b1111111,
  ...
  localparam REQ_BUFF_SIZE_EP0 = 65536;
  ...
  // If requested buffer size is 0, use the minimum SRL-based FIFO size.
  // Otherwise, make sure it's at least two MTU-sized packets.
  localparam REQ_BUFF_SIZE_EP1 = 65536;
  ...
  // If requested buffer size is 0, use the minimum SRL-based FIFO size.
  // Otherwise, make sure it's at least two MTU-sized packets.
  localparam REQ_BUFF_SIZE_EP2 = 4096;
  ...
  // If requested buffer size is 0, use the minimum SRL-based FIFO size.
  // Otherwise, make sure it's at least two MTU-sized packets.
  localparam REQ_BUFF_SIZE_EP3 = 4096;
  ...
  wire                    duc0_ce_clk;
  wire [BLOCK_CHDR_W-1:0] s_duc0_in_0_tdata ;
  wire                    s_duc0_in_0_tlast ;
  wire                    s_duc0_in_0_tvalid;
  wire                    s_duc0_in_0_tready;
  wire [BLOCK_CHDR_W-1:0] m_duc0_out_0_tdata ;
  ...
  wire                    ddc0_ce_clk;
  wire [BLOCK_CHDR_W-1:0] s_ddc0_in_0_tdata ;
  wire                    s_ddc0_in_0_tlast ;
  wire                    s_ddc0_in_0_tvalid;
  wire                    s_ddc0_in_0_tready;
  wire [BLOCK_CHDR_W-1:0] m_ddc0_out_0_tdata ;
  ...
  wire                    duc1_ce_clk;
  wire [BLOCK_CHDR_W-1:0] s_duc1_in_0_tdata ;
  wire                    s_duc1_in_0_tlast ;
  wire                    s_duc1_in_0_tvalid;
  wire                    s_duc1_in_0_tready;
  wire [BLOCK_CHDR_W-1:0] m_duc1_out_0_tdata ;
  ...
  wire                    ddc1_ce_clk;
  wire [BLOCK_CHDR_W-1:0] s_ddc1_in_0_tdata ;
  wire                    s_ddc1_in_0_tlast ;
  wire                    s_ddc1_in_0_tvalid;
  wire                    s_ddc1_in_0_tready;
  wire [BLOCK_CHDR_W-1:0] m_ddc1_out_0_tdata ;
