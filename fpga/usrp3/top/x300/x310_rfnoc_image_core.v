...
module rfnoc_image_core #(
  ...
  chdr_crossbar_nxn #(
    .PORT_W         (PORT_W),
    .NPORTS         (9),
    .CHDR_WIDTHS    ({EP5_W, EP4_W, EP3_W, EP2_W, EP1_W, EP0_W, PCIE_W, ETH1_W, ETH0_W}),
    .DEFAULT_PORT   (0),
    .ROUTES         ({ 9'b111111111,
                       9'b111111111,
                       9'b111111111,
  ...
  // If requested buffer size is 0, use the minimum SRL-based FIFO size.
  // Otherwise, make sure it's at least two MTU-sized packets.
  localparam REQ_BUFF_SIZE_EP2 = 65536;
