...
BUILD_VIVADO_DESIGN = \
	...
	export VIV_SYNTH_ONLY=$(VIV_SYNTH_ONLY); \
...
# Out-of-tree sources file generation (shared by all platforms)
# Note: The target rule for this file must be defined after RFNOC_OOT_SRCS is populated
OOT_SRCS_FILE := $(BUILD_DIR)/rfnoc_oot.srcs
