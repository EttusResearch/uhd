...
Example usage:
replay_capture.py --args addr=192.168.10.2,type=x300
                  --output-file captured_samples.dat --rate 10e6 --freq 1e9 1.1e9
                  --gain 20 30 --antenna TX/RX RX2 --duration 5
                  --radio-channels "0/Radio#0:0" "0/Radio#0:1" --block "0/Replay#0"
                  --pkt-size 1472 --numpy
