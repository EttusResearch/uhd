...
//
// File generated on: 2022-05-19T16:36:40.674381
// Source: /home/whan/src/rfnoc-convertb/icores/x310_rfnoc_image_core.yml
// Source SHA256: d562fc0904fd9d39276828b076acec0f54b1430406c755fe14e5dd031c185176
//
...
module rfnoc_image_core #(
  ...
  wire [31:0] m_bitdown0_ctrl_tdata,  s_bitdown0_ctrl_tdata;
  wire        m_bitdown0_ctrl_tlast,  s_bitdown0_ctrl_tlast;
  wire        m_bitdown0_ctrl_tvalid, s_bitdown0_ctrl_tvalid;
  wire        m_bitdown0_ctrl_tready, s_bitdown0_ctrl_tready;
  ...
  axis_ctrl_crossbar_nxn #(
    ...
    .s_axis_tdata     ({m_bitdown0_ctrl_tdata , m_radio1_ctrl_tdata , m_ddc1_ctrl_tdata , m_radio0_ctrl_tdata , m_ddc0_ctrl_tdata , m_ep0_ctrl_tdata , m_core_ctrl_tdata }),
    .s_axis_tvalid    ({m_bitdown0_ctrl_tvalid, m_radio1_ctrl_tvalid, m_ddc1_ctrl_tvalid, m_radio0_ctrl_tvalid, m_ddc0_ctrl_tvalid, m_ep0_ctrl_tvalid, m_core_ctrl_tvalid}),
    .s_axis_tlast     ({m_bitdown0_ctrl_tlast , m_radio1_ctrl_tlast , m_ddc1_ctrl_tlast , m_radio0_ctrl_tlast , m_ddc0_ctrl_tlast , m_ep0_ctrl_tlast , m_core_ctrl_tlast }),
    .s_axis_tready    ({m_bitdown0_ctrl_tready, m_radio1_ctrl_tready, m_ddc1_ctrl_tready, m_radio0_ctrl_tready, m_ddc0_ctrl_tready, m_ep0_ctrl_tready, m_core_ctrl_tready}),
    .m_axis_tdata     ({s_bitdown0_ctrl_tdata , s_radio1_ctrl_tdata , s_ddc1_ctrl_tdata , s_radio0_ctrl_tdata , s_ddc0_ctrl_tdata , s_ep0_ctrl_tdata , s_core_ctrl_tdata }),
    .m_axis_tvalid    ({s_bitdown0_ctrl_tvalid, s_radio1_ctrl_tvalid, s_ddc1_ctrl_tvalid, s_radio0_ctrl_tvalid, s_ddc0_ctrl_tvalid, s_ep0_ctrl_tvalid, s_core_ctrl_tvalid}),
    .m_axis_tlast     ({s_bitdown0_ctrl_tlast , s_radio1_ctrl_tlast , s_ddc1_ctrl_tlast , s_radio0_ctrl_tlast , s_ddc0_ctrl_tlast , s_ep0_ctrl_tlast , s_core_ctrl_tlast }),
    .m_axis_tready    ({s_bitdown0_ctrl_tready, s_radio1_ctrl_tready, s_ddc1_ctrl_tready, s_radio0_ctrl_tready, s_ddc0_ctrl_tready, s_ep0_ctrl_tready, s_core_ctrl_tready}),
    .deadlock_detected()
  );
  ...
  wire [(512*5)-1:0] rfnoc_core_config, rfnoc_core_status;
  ...
  wire              bitdown0_ce_clk;
  wire [CHDR_W-1:0] s_bitdown0_in_1_tdata , s_bitdown0_in_0_tdata ;
  wire              s_bitdown0_in_1_tlast , s_bitdown0_in_0_tlast ;
  wire              s_bitdown0_in_1_tvalid, s_bitdown0_in_0_tvalid;
  wire              s_bitdown0_in_1_tready, s_bitdown0_in_0_tready;
  wire [CHDR_W-1:0] m_bitdown0_out_1_tdata , m_bitdown0_out_0_tdata ;
  wire              m_bitdown0_out_1_tlast , m_bitdown0_out_0_tlast ;
  wire              m_bitdown0_out_1_tvalid, m_bitdown0_out_0_tvalid;
  wire              m_bitdown0_out_1_tready, m_bitdown0_out_0_tready;
  ...
  rfnoc_block_bitdown #(
    ...
    .rfnoc_chdr_clk      (rfnoc_chdr_clk),
    .rfnoc_ctrl_clk      (rfnoc_ctrl_clk),
    .ce_clk              (bitdown0_ce_clk),
    .rfnoc_core_config   (rfnoc_core_config[512*5-1:512*4]),
    .rfnoc_core_status   (rfnoc_core_status[512*5-1:512*4]),
    .s_rfnoc_chdr_tdata  ({s_bitdown0_in_1_tdata , s_bitdown0_in_0_tdata }),
    .s_rfnoc_chdr_tlast  ({s_bitdown0_in_1_tlast , s_bitdown0_in_0_tlast }),
    .s_rfnoc_chdr_tvalid ({s_bitdown0_in_1_tvalid, s_bitdown0_in_0_tvalid}),
    .s_rfnoc_chdr_tready ({s_bitdown0_in_1_tready, s_bitdown0_in_0_tready}),
    .m_rfnoc_chdr_tdata  ({m_bitdown0_out_1_tdata , m_bitdown0_out_0_tdata }),
    .m_rfnoc_chdr_tlast  ({m_bitdown0_out_1_tlast , m_bitdown0_out_0_tlast }),
    .m_rfnoc_chdr_tvalid ({m_bitdown0_out_1_tvalid, m_bitdown0_out_0_tvalid}),
    .m_rfnoc_chdr_tready ({m_bitdown0_out_1_tready, m_bitdown0_out_0_tready}),
    .s_rfnoc_ctrl_tdata  (s_bitdown0_ctrl_tdata),
    .s_rfnoc_ctrl_tlast  (s_bitdown0_ctrl_tlast),
    .s_rfnoc_ctrl_tvalid (s_bitdown0_ctrl_tvalid),
    .s_rfnoc_ctrl_tready (s_bitdown0_ctrl_tready),
    .m_rfnoc_ctrl_tdata  (m_bitdown0_ctrl_tdata),
    .m_rfnoc_ctrl_tlast  (m_bitdown0_ctrl_tlast),
    .m_rfnoc_ctrl_tvalid (m_bitdown0_ctrl_tvalid),
    .m_rfnoc_ctrl_tready (m_bitdown0_ctrl_tready)
  );
  ...
  assign s_bitdown0_in_0_tdata = m_ep4_out0_tdata;
  assign s_bitdown0_in_0_tlast = m_ep4_out0_tlast;
  assign s_bitdown0_in_0_tvalid = m_ep4_out0_tvalid;
  assign m_ep4_out0_tready = s_bitdown0_in_0_tready;

  assign s_ep4_in0_tdata = m_bitdown0_out_0_tdata;
  assign s_ep4_in0_tlast = m_bitdown0_out_0_tlast;
  assign s_ep4_in0_tvalid = m_bitdown0_out_0_tvalid;
  assign m_bitdown0_out_0_tready = s_ep4_in0_tready;

  assign s_bitdown0_in_1_tdata = m_ep5_out0_tdata;
  assign s_bitdown0_in_1_tlast = m_ep5_out0_tlast;
  assign s_bitdown0_in_1_tvalid = m_ep5_out0_tvalid;
  assign m_ep5_out0_tready = s_bitdown0_in_1_tready;

  assign s_ep5_in0_tdata = m_bitdown0_out_1_tdata;
  assign s_ep5_in0_tlast = m_bitdown0_out_1_tlast;
  assign s_ep5_in0_tvalid = m_bitdown0_out_1_tvalid;
  assign m_bitdown0_out_1_tready = s_ep5_in0_tready;
  ...
  assign s_radio0_in_0_tdata  = {CHDR_W{1'b0}};
  assign s_radio0_in_0_tlast  = 1'b0;
  assign s_radio0_in_0_tvalid = 1'b0;
  assign s_radio0_in_1_tdata  = {CHDR_W{1'b0}};
  assign s_radio0_in_1_tlast  = 1'b0;
  assign s_radio0_in_1_tvalid = 1'b0;
  assign s_radio1_in_0_tdata  = {CHDR_W{1'b0}};
  assign s_radio1_in_0_tlast  = 1'b0;
  assign s_radio1_in_0_tvalid = 1'b0;
  assign s_radio1_in_1_tdata  = {CHDR_W{1'b0}};
  assign s_radio1_in_1_tlast  = 1'b0;
  assign s_radio1_in_1_tvalid = 1'b0;
  assign m_ep0_out0_tready = 1'b1;
  assign m_ep1_out0_tready = 1'b1;
  assign m_ep2_out0_tready = 1'b1;
