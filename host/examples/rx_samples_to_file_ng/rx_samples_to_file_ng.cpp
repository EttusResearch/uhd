...
int UHD_SAFE_MAIN(int argc, char *argv[]){
    ...
    desc.add_options()
        ...
        ("type", po::value<std::string>(&type)->default_value("short"), "sample type: double, float, short or char")
...
#define recv_to_file_args(format) \
    ...
    else if (type == "char") recv_to_file<std::complex<char> >recv_to_file_args("sc8");
