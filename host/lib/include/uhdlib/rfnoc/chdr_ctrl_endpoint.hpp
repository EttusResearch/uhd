...
public:
    ...
    /*! \brief Creates a new register interface for the specified port.
     *
    ...
    /*! \brief Returns the number of dropped packets due to misclassification.
     *
    ...
    /*! \brief Creates a control endpoint object.
     *
     * \param xport The transport used to send and recv packets
     * \param pkt_factory An instance of the CHDR packet factory
