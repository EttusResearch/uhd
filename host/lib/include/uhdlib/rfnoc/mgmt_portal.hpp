...
/*! \brief A portal to perform low-level management operations from an endpoint.
 *
...
public:
    ...
    /*! \brief Initialize a stream endpoint and assign an endpoint ID to it.
     *
    ...
    /*! \brief Register an already-initialized stream endpoint's endpoint ID.
     *
     * This should only be called by the epid_allocator
     *
     * \param addr The physical address of the stream endpoint
    ...
    /*! \brief Get information about a discovered (reachable) stream endpoint.
     *
    ...
    /*! \brief Setup a route from this SW mgmt portal to the specified destination
     * endpoint.
     *
    ...
    /*! \brief Can a route from between the source and destination endpoints be
     * established?
     *
     * \param dst_epid The endpoint ID of the destination
    ...
    /*! \brief Setup a route from between the source and destination endpoints.
     *
    ...
    /*! \brief Start configuring a flow controlled receive data stream from the endpoint
     * with the specified ID to this SW mgmt portal.
     *
    ...
    /*! \brief Finish configuring a flow controlled receive data stream from the endpoint
     * with the specified ID to this SW mgmt portal.
     *
     * \param xport The host stream endpoint's CTRL transport (same EPID as RX stream)
     * \param epid The endpoint ID of the data source
    ...
    /*! \brief Configure a flow controlled transmit data stream from this SW mgmt portal
     * to the endpoint with the specified ID.
     *
    ...
    /*! \brief Configure a flow controlled data stream from the endpoint with ID src_epid
     * to the endpoint with ID dst_epid.
     *
     * \param xport The host stream endpoint's CTRL transport
     * \param dst_epid The endpoint ID of the destination
     * \param src_epid The endpoint ID of the source
    ...
    /*! \brief Define custom configuration functions for custom transports.
     *
    ...
    /*! \brief Create an endpoint manager object
     *
