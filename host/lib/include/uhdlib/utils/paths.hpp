...
/*! \brief Compatibility function for deprecated CSV file reader. Remove this when CSV
 * format for IQ/DC cal gets removed.
 */
std::string get_appdata_path(void);

/*! \brief Return a path to XDG_DATA_HOME.
 *
...
/*! \brief Return a path to XDG_CONFIG_HOME.
 *
 * https://specifications.freedesktop.org/basedir-spec/basedir-spec-latest.html
 *
...
/*! \brief Return the path to a UHD command.
 *
