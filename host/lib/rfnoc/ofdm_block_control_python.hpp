...
void export_ofdm_block_control(py::module& m)
{
    ...
    py::class_<ofdm_block_control, noc_block_base, ofdm_block_control::sptr>(
        ...
        .def("reset", &ofdm_block_control::reset)
        ...
        .def("set_cp_insertion_length", &ofdm_block_control::set_cp_insertion_length)
        .def("get_cp_insertion_length", &ofdm_block_control::get_cp_insertion_length)
        .def("set_cp_removal_length", &ofdm_block_control::set_cp_removal_length)
        .def("get_cp_removal_length", &ofdm_block_control::get_cp_removal_length)
        ...
        .def("get_cp_insertion_fifo_occupancy", &ofdm_block_control::get_cp_insertion_fifo_occupancy)
        ...
        .def("get_cp_removal_fifo_occupancy", &ofdm_block_control::get_cp_removal_fifo_occupancy)
        ;
}
