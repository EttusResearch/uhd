        ...
        switch (_iface->get_rev()) {
            ...
            default:
                throw uhd::not_implemented_error(
                        "enable_tx_dboard_clock: unknown hardware version");
                break;
        }
    ...
    void set_rate_tx_dboard_clock(double rate) override {
        ...
        switch (_iface->get_rev()) {
            ...
            default:
                ...
                } else if (clk_regs.tx_db == 6) { // USRP2
                    // bypass when the divider ratio is one
    ...
    void enable_external_ref(bool enb) override {
        switch (_iface->get_rev()) {
            ...
            case usrp2_iface::USRP_N210_XA:
                ...
                break;
            default:
                _ad9510_regs.charge_pump_mode =
                        (enb) ? ad9510_regs_t::CHARGE_PUMP_MODE_NORMAL
...
private:
    ...
    void enable_dac_clock(bool enb) {
        switch (_iface->get_rev()) {
            case usrp2_iface::USRP_N210_XK:
                ...
                _ad9516_regs.output_level_lvpecl_out3 =
                        ad9516_regs_t::OUTPUT_LEVEL_LVPECL_OUT3_780MV;
                break;
            case usrp2_iface::USRP_N210_XA:
                ...
                _ad9516_regs.output_level_lvpecl_out0 =
                        ad9516_regs_t::OUTPUT_LEVEL_LVPECL_OUT0_780MV;
        ...
        this->write_reg(clk_regs.div_lo(
                clk_regs.dac)); // TODO: Проверить, в новом UHD нет этой строки
        this->update_regs();
    }
    ...
    void enable_adc_clock(bool enb) {
        switch (_iface->get_rev()) {
            case usrp2_iface::USRP_N210_XK:
            case usrp2_iface::USRP_N210_XA:
                _ad9516_regs.power_down_lvpecl_out1 =
                        enb ? ad9516_regs_t::POWER_DOWN_LVPECL_OUT1_NORMAL
                            : ad9516_regs_t::POWER_DOWN_LVPECL_OUT1_SAFE_PD;
                _ad9516_regs.output_level_lvpecl_out1 =
                        ad9516_regs_t::OUTPUT_LEVEL_LVPECL_OUT1_780MV;
                _ad9516_regs.divider0_bypass = 1;
                break;
            default:
                switch (clk_regs.adc) {
        ...
        this->write_reg(clk_regs.div_lo(
                clk_regs.adc)); // TODO: Проверить, в новом UHD нет этой строки
        this->update_regs();
    }
