...
#define U2_REG_TX_CTRL_CYCLES_PER_ACK    _SR_ADDR(SR_TX_CTRL + 4)
#define U2_REG_TX_CTRL_PACKETS_PER_ACK   _SR_ADDR(SR_TX_CTRL + 5)
...
//enable flag for registers: cycles and packets per ack
#define U2_FLAG_TX_CTRL_ACK_ENB              (1ul << 31)
