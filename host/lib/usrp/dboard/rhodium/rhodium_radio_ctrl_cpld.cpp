...
void rhodium_radio_ctrl_impl::_update_rx_freq_switches(const double freq)
{
    UHD_LOG_TRACE(
...
void rhodium_radio_ctrl_impl::_update_tx_freq_switches(const double freq)
{
    UHD_LOG_TRACE(
...
void rhodium_radio_ctrl_impl::_update_rx_input_switches(const std::string& input)
{
    UHD_LOG_TRACE(unique_id(), "Update all RX input related switches. input=" << input);
...
void rhodium_radio_ctrl_impl::_update_tx_output_switches(const std::string& output)
{
    UHD_LOG_TRACE(
        unique_id(), "Update all TX output related switches. output=" << output);
    ...
    UHD_LOG_TRACE(unique_id(), "Selected switch values: sw1=" << sw1);
