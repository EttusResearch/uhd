...
const std::vector<std::string> RHODIUM_GP_OPTIONS = {"default"};
...
void rhodium_radio_ctrl_impl::_init_defaults()
{
    ...
    if (_block_args.has_key(SPUR_DODGING_THRESHOLD_ARG_NAME)) {
        _tree->access<double>(get_arg_path(SPUR_DODGING_THRESHOLD_ARG_NAME) / "value")
            .set(boost::lexical_cast<double>(
                _block_args.get(SPUR_DODGING_THRESHOLD_ARG_NAME)));
    }
...
void rhodium_radio_ctrl_impl::_init_peripherals()
{
    ...
    _gpio = usrp::gpio_atr::gpio_atr_3000::make(
        _get_ctrl(0), regs::sr_addr(regs::GPIO), regs::rb_addr(regs::RB_DB_GPIO));
    ...
    UHD_LOG_DEBUG(unique_id(),
        str(boost::format("LO distribution board is%s present")
            % (_lo_dist_present ? "" : " NOT")));
}
    ...
    uhd::property_tree::sptr subtree, const size_t chan_idx)
{
    ...
    subtree->create<std::string>(tx_fe_path / "name").set(str(boost::format("Rhodium")));
    ...
    subtree->create<device_addr_t>(tx_fe_path / "tune_args").set(device_addr_t());
    // RX Standard attributes
    subtree->create<std::string>(rx_fe_path / "name").set(str(boost::format("Rhodium")));
    ...
    subtree->create<device_addr_t>(rx_fe_path / "tune_args").set(device_addr_t());
    // TX Antenna
    ...
    subtree->create<double>(rx_fe_path / "los" / RHODIUM_LO1 / "freq/value")
        .set_publisher(
            [this, chan_idx]() { return this->get_rx_lo_freq(RHODIUM_LO1, chan_idx); })
        .set_coercer([this, chan_idx](const double freq) {
    ...
    subtree->create<std::string>(rx_fe_path / "los" / RHODIUM_LO1 / "source/value")
        ...
        .set_publisher(
            [this, chan_idx]() { return this->get_rx_lo_source(RHODIUM_LO1, chan_idx); });
    // RX LO1 Export
    ...
    subtree
        ...
        .set_publisher(
            [this, chan_idx]() { return this->get_rx_lo_gain(RHODIUM_LO1, chan_idx); })
    ...
    subtree
        ...
        .set_publisher([]() { return rhodium_radio_ctrl_impl::_get_lo_gain_range(); })
        .add_coerced_subscriber([](const meta_range_t&) {
    ...
    subtree
        ...
        .set_publisher(
            [this, chan_idx]() { return this->get_rx_lo_power(RHODIUM_LO1, chan_idx); })
        .set_coercer([this, chan_idx](const double gain) {
    ...
    subtree
        ...
        .set_publisher([]() { return rhodium_radio_ctrl_impl::_get_lo_power_range(); })
        .add_coerced_subscriber([](const meta_range_t&) {
    ...
    subtree->create<double>(rx_fe_path / "los" / RHODIUM_LO2 / "freq/value")
        .set_publisher(
            [this, chan_idx]() { return this->get_rx_lo_freq(RHODIUM_LO2, chan_idx); })
    ...
    subtree->create<std::string>(rx_fe_path / "los" / RHODIUM_LO2 / "source/value")
        ...
        .set_publisher(
            [this, chan_idx]() { return this->get_rx_lo_source(RHODIUM_LO2, chan_idx); });
    // RX LO2 Export
    ...
    subtree->create<std::string>(rx_fe_path / "los" / ALL_LOS / "source/value")
        ...
        .set_publisher(
            [this, chan_idx]() { return this->get_rx_lo_source(ALL_LOS, chan_idx); });
    subtree
        ->create<std::vector<std::string>>(
            rx_fe_path / "los" / ALL_LOS / "source/options")
        .set_publisher(
            [this, chan_idx]() { return this->get_rx_lo_sources(ALL_LOS, chan_idx); });
    ...
    subtree->create<double>(tx_fe_path / "los" / RHODIUM_LO1 / "freq/value ")
        .set_publisher(
            [this, chan_idx]() { return this->get_tx_lo_freq(RHODIUM_LO1, chan_idx); })
        .set_coercer([this, chan_idx](double freq) {
    ...
    subtree->create<std::string>(tx_fe_path / "los" / RHODIUM_LO1 / "source/value")
        ...
        .set_publisher(
            [this, chan_idx]() { return this->get_tx_lo_source(RHODIUM_LO1, chan_idx); });
    // TX LO1 Export
    ...
    subtree
        ...
        .set_publisher(
            [this, chan_idx]() { return this->get_tx_lo_gain(RHODIUM_LO1, chan_idx); })
        .set_coercer([this, chan_idx](const double gain) {
    ...
    subtree
        ...
        .set_publisher(
            [this, chan_idx]() { return this->get_tx_lo_power(RHODIUM_LO1, chan_idx); })
        .set_coercer([this, chan_idx](const double gain) {
    ...
    subtree->create<double>(tx_fe_path / "los" / RHODIUM_LO2 / "freq/value")
        .set_publisher(
            [this, chan_idx]() { return this->get_tx_lo_freq(RHODIUM_LO2, chan_idx); })
        .set_coercer([this, chan_idx](double freq) {
    ...
    subtree->create<std::string>(tx_fe_path / "los" / RHODIUM_LO2 / "source/value")
        ...
        .set_publisher(
            [this, chan_idx]() { return this->get_tx_lo_source(RHODIUM_LO2, chan_idx); });
    // TX LO2 Export
    ...
    subtree->create<std::string>(tx_fe_path / "los" / ALL_LOS / "source/value")
        ...
        .set_publisher(
            [this, chan_idx]() { return this->get_tx_lo_source(ALL_LOS, chan_idx); });
    subtree
        ->create<std::vector<std::string>>(
            tx_fe_path / "los" / ALL_LOS / "source/options")
        .set_publisher(
            [this, chan_idx]() { return this->get_tx_lo_sources(ALL_LOS, chan_idx); });
...
void rhodium_radio_ctrl_impl::_init_prop_tree()
{
    ...
    auto eeprom_set = [](dboard_eeprom_t) {
        throw uhd::not_implemented_error(
            "Setting DB EEPROM from this interface not implemented");
    };
