...
/***********************************************************************
 * DB_KINTEX7SDR Data Structures
 **********************************************************************/
enum db_kintex7sdr_gpio_field_id_t {
    SPI_ADDR,
    TX_EN_N,
    RX_EN_N,
    RX_ANT,
...
enum db_kintex7sdr_cpld_field_id_t {
    TXHB_SEL        = 0,
    TXLB_SEL        = 1,
    TXLO1_FSEL1     = 2,
    TXLO1_FSEL2     = 3,
...
struct db_kintex7sdr_gpio_field_info_t
{
    db_kintex7sdr_gpio_field_id_t id;
...
struct db_kintex7sdr_gpio_reg_t
{
    bool dirty;
    uint32_t value;
    uint32_t mask;
...
struct db_kintex7sdr_cpld_reg_t
{
    void set_field(db_kintex7sdr_cpld_field_id_t field, uint32_t val)
    {
...
/***********************************************************************
 * DB_KINTEX7SDR Constants
 **********************************************************************/
#define fMHz (1000000.0)
static const freq_range_t db_kintex7sdr_freq_range(10e6, 6.0e9);
static const gain_range_t db_kintex7sdr_tx_gain_range(0, 31.5, double(0.5));
static const gain_range_t db_kintex7sdr_rx_gain_range(0, 31.5, double(0.5));
static const std::vector<std::string> db_kintex7sdr_pgas{"PGA-TX", "PGA-RX"};
static const std::vector<std::string> db_kintex7sdr_plls{"TXLO", "RXLO"};
static const std::vector<std::string> db_kintex7sdr_tx_antennas{"TX/RX", "CAL"};
static const std::vector<std::string> db_kintex7sdr_rx_antennas{"TX/RX", "RX2", "CAL"};
static const std::vector<std::string> db_kintex7sdr_power_modes{"performance", "powersave"};
static const std::vector<std::string> db_kintex7sdr_xcvr_modes{"FDX", "TX", "TX/RX", "RX"};
static const std::vector<std::string> db_kintex7sdr_temp_comp_modes{"enabled", "disabled"};

// clang-format off
static const db_kintex7sdr_gpio_field_info_t db_kintex7sdr_proto_gpio_info[] = {
    //Field         Unit                  Offset Mask      Width    Direction                   ATR    IDLE,TX,RX,FDX
    {SPI_ADDR,      dboard_iface::UNIT_TX,  0,  0x7,        3,  db_kintex7sdr_gpio_field_info_t::INPUT,  false,  0,  0,  0,  0},
    {TX_EN_N,       dboard_iface::UNIT_TX,  3,  0x1<<3,     1,  db_kintex7sdr_gpio_field_info_t::INPUT,  true,   1,  0,  1,  0},
    {RX_EN_N,       dboard_iface::UNIT_TX,  4,  0x1<<4,     1,  db_kintex7sdr_gpio_field_info_t::INPUT,  true,   1,  1,  0,  0},
    {RX_ANT,        dboard_iface::UNIT_TX,  5,  0x1<<5,     1,  db_kintex7sdr_gpio_field_info_t::INPUT,  false,  0,  0,  0,  0},
    {TX_LO_LOCKED,  dboard_iface::UNIT_TX,  6,  0x1<<6,     1,  db_kintex7sdr_gpio_field_info_t::OUTPUT, false,  0,  0,  0,  0},
    {RX_LO_LOCKED,  dboard_iface::UNIT_TX,  7,  0x1<<7,     1,  db_kintex7sdr_gpio_field_info_t::OUTPUT, false,  0,  0,  0,  0},
    {CPLD_RST_N,    dboard_iface::UNIT_TX,  9,  0x1<<9,     1,  db_kintex7sdr_gpio_field_info_t::INPUT,  false,  0,  0,  0,  0},
    {TX_GAIN,       dboard_iface::UNIT_TX,  10, 0x3F<<10,   10, db_kintex7sdr_gpio_field_info_t::INPUT,  false,  0,  0,  0,  0},
    {RX_GAIN,       dboard_iface::UNIT_RX,  10, 0x3F<<10,   10, db_kintex7sdr_gpio_field_info_t::INPUT,  false,  0,  0,  0,  0}
};

static const db_kintex7sdr_gpio_field_info_t db_kintex7sdr_v1_gpio_info[] = {
    //Field         Unit                  Offset Mask      Width    Direction                   ATR    IDLE,TX,RX,FDX
    {SPI_ADDR,      dboard_iface::UNIT_TX,   0,  0x7,        3,  db_kintex7sdr_gpio_field_info_t::INPUT,  false,  0,  0,  0,  0},
    {CPLD_RST_N,    dboard_iface::UNIT_TX,   3,  0x1<<3,     1,  db_kintex7sdr_gpio_field_info_t::INPUT,  false,  0,  0,  0,  0},
    {RX_ANT,        dboard_iface::UNIT_TX,   4,  0x1<<4,     1,  db_kintex7sdr_gpio_field_info_t::INPUT,  false,  0,  0,  0,  0},
    {TX_EN_N,       dboard_iface::UNIT_TX,   5,  0x1<<5,     1,  db_kintex7sdr_gpio_field_info_t::INPUT,  true,   1,  0,  1,  0},
    {RX_EN_N,       dboard_iface::UNIT_TX,   6,  0x1<<6,     1,  db_kintex7sdr_gpio_field_info_t::INPUT,  true,   1,  1,  0,  0},
    {TXLO1_SYNC,    dboard_iface::UNIT_TX,   7,  0x1<<7,     1,  db_kintex7sdr_gpio_field_info_t::INPUT,  true,   0,  0,  0,  0},
    {TXLO2_SYNC,    dboard_iface::UNIT_TX,   9,  0x1<<9,     1,  db_kintex7sdr_gpio_field_info_t::INPUT,  true,   0,  0,  0,  0},
    {TX_GAIN,       dboard_iface::UNIT_TX,   10, 0x3F<<10,   10, db_kintex7sdr_gpio_field_info_t::INPUT,  false,  0,  0,  0,  0},
    {RX_LO_LOCKED,  dboard_iface::UNIT_RX,   0,  0x1,        1,  db_kintex7sdr_gpio_field_info_t::OUTPUT, false,  0,  0,  0,  0},
    {TX_LO_LOCKED,  dboard_iface::UNIT_RX,   1,  0x1<<1,     1,  db_kintex7sdr_gpio_field_info_t::OUTPUT, false,  0,  0,  0,  0},
    {RXLO1_SYNC,    dboard_iface::UNIT_RX,   5,  0x1<<5,     1,  db_kintex7sdr_gpio_field_info_t::INPUT,  true,   0,  0,  0,  0},
    {RXLO2_SYNC,    dboard_iface::UNIT_RX,   7,  0x1<<7,     1,  db_kintex7sdr_gpio_field_info_t::INPUT,  true,   0,  0,  0,  0},
    {RX_GAIN,       dboard_iface::UNIT_RX,   10, 0x3F<<10,   10, db_kintex7sdr_gpio_field_info_t::INPUT,  false,  0,  0,  0,  0}
};
// clang-format on
...
/***********************************************************************
 * DB_KINTEX7SDR Class Definition
 **********************************************************************/
class db_kintex7sdr_xcvr : public xcvr_dboard_base
{
public:
    db_kintex7sdr_xcvr(ctor_args_t args) : xcvr_dboard_base(args)
    {
        double bw           = 40e6;
        ...
        if (rx_id == DB_KINTEX7SDR_PROTO_V3_RX_ID and tx_id == DB_KINTEX7SDR_PROTO_V3_TX_ID) {
            _rev = 0;
        } else if (rx_id == DB_KINTEX7SDR_PROTO_V4_RX_ID and tx_id == DB_KINTEX7SDR_PROTO_V4_TX_ID) {
            _rev = 1;
        } else if (rx_id == DB_KINTEX7SDR_V1_40MHZ_RX_ID and tx_id == DB_KINTEX7SDR_V1_40MHZ_TX_ID) {
            _rev = 1;
        } else if (rx_id == DB_KINTEX7SDR_V2_40MHZ_RX_ID and tx_id == DB_KINTEX7SDR_V2_40MHZ_TX_ID) {
            _rev = 2;
            if (revision >= 4) {
                _high_isolation = true;
            }
        } else if (rx_id == DB_KINTEX7SDR_V1_160MHZ_RX_ID and tx_id == DB_KINTEX7SDR_V1_160MHZ_TX_ID) {
            bw   = 160e6;
            _rev = 1;
        } else if (rx_id == DB_KINTEX7SDR_V2_160MHZ_RX_ID and tx_id == DB_KINTEX7SDR_V2_160MHZ_TX_ID) {
            bw   = 160e6;
            _rev = 2;
            if (revision >= 4) {
                _high_isolation = true;
            }
        } else if (rx_id == DB_KINTEX7SDR_LP_160MHZ_RX_ID and tx_id == DB_KINTEX7SDR_LP_160MHZ_TX_ID) {
            // The LP version behaves and looks like a regular DB_KINTEX7SDR-160 v2
            bw   = 160e6;
            _rev = 2;
        } else if (rx_id == DB_KINTEX7SDR_TDD_160MHZ_RX_ID and tx_id == DB_KINTEX7SDR_TDD_160MHZ_TX_ID) {
            bw              = 160e6;
            _rev            = 2;
            _high_isolation = true;
        } else {
        ...
        switch (_rev) {
            case 0:
                for (size_t i = 0;
                     i < sizeof(db_kintex7sdr_proto_gpio_info) / sizeof(db_kintex7sdr_gpio_field_info_t);
                     i++)
                    _gpio_map[db_kintex7sdr_proto_gpio_info[i].id] = db_kintex7sdr_proto_gpio_info[i];
                pfd_freq_max = 25e6;
                break;
            case 1:
            case 2:
                for (size_t i = 0;
                     i < sizeof(db_kintex7sdr_v1_gpio_info) / sizeof(db_kintex7sdr_gpio_field_info_t);
                     i++)
                    _gpio_map[db_kintex7sdr_v1_gpio_info[i].id] = db_kintex7sdr_v1_gpio_info[i];
                pfd_freq_max = 50e6;
                break;
        }

        // Initialize GPIO registers
        memset(&_tx_gpio_reg, 0, sizeof(db_kintex7sdr_gpio_reg_t));
        memset(&_rx_gpio_reg, 0, sizeof(db_kintex7sdr_gpio_reg_t));
        for (std::map<db_kintex7sdr_gpio_field_id_t, db_kintex7sdr_gpio_field_info_t>::iterator entry =
                 _gpio_map.begin();
             entry != _gpio_map.end();
             entry++) {
            db_kintex7sdr_gpio_field_info_t info = entry->second;
            db_kintex7sdr_gpio_reg_t* reg =
                (info.unit == dboard_iface::UNIT_TX ? &_tx_gpio_reg : &_rx_gpio_reg);
            if (info.direction == db_kintex7sdr_gpio_field_info_t::INPUT)
                reg->ddr |= info.mask;
        ...
        if (_rev >= 1) {
            ...
            if (_iface->get_clock_rate(dboard_iface::UNIT_RX) > pfd_freq_max) {
                ...
                try {
                    ...
                    UHD_LOG_WARNING(
                        "DB_KINTEX7SDR", "Unable to set dboard clock rate - phase will vary");
        ...
        // Set direction of GPIO pins (1 is input to DB_KINTEX7SDR, 0 is output)
        ...
        if (_rev == 0) {
            _txlo1 = max287x_iface::make<max2870>(
                std::bind(&db_kintex7sdr_xcvr::write_spi_regs, this, TXLO1, std::placeholders::_1));
            _txlo2 = max287x_iface::make<max2870>(
                std::bind(&db_kintex7sdr_xcvr::write_spi_regs, this, TXLO2, std::placeholders::_1));
            _rxlo1 = max287x_iface::make<max2870>(
                std::bind(&db_kintex7sdr_xcvr::write_spi_regs, this, RXLO1, std::placeholders::_1));
            _rxlo2 = max287x_iface::make<max2870>(
                std::bind(&db_kintex7sdr_xcvr::write_spi_regs, this, RXLO2, std::placeholders::_1));
        ...
        get_rx_subtree()
            ...
            .set(db_kintex7sdr_power_modes);
        get_rx_subtree()
            ->create<std::string>("power_mode/value")
            .add_coerced_subscriber(
                std::bind(&db_kintex7sdr_xcvr::set_power_mode, this, std::placeholders::_1))
            .set("performance");
        get_rx_subtree()
            ->create<std::vector<std::string>>("xcvr_mode/options")
            .set(db_kintex7sdr_xcvr_modes);
        get_rx_subtree()
            ->create<std::string>("xcvr_mode/value")
            .add_coerced_subscriber(
                std::bind(&db_kintex7sdr_xcvr::set_xcvr_mode, this, std::placeholders::_1))
            .set("FDX");
        get_rx_subtree()
            ->create<std::vector<std::string>>("temp_comp_mode/options")
            .set(db_kintex7sdr_temp_comp_modes);
        get_rx_subtree()
        ...
        ////////////////////////////////////////////////////////////////////
        get_tx_subtree()->create<std::string>("name").set("DB_KINTEX7SDR TX");
        get_tx_subtree()->create<device_addr_t>("tune_args").set(device_addr_t());
        get_tx_subtree()
            ->create<sensor_value_t>("sensors/lo_locked")
            .set_publisher(std::bind(&db_kintex7sdr_xcvr::get_locked, this, "TXLO"));
        get_tx_subtree()
            ->create<double>("gains/PGA0/value")
            .set_coercer(std::bind(&db_kintex7sdr_xcvr::set_tx_gain, this, std::placeholders::_1))
            .set(0);
        get_tx_subtree()->create<meta_range_t>("gains/PGA0/range").set(db_kintex7sdr_tx_gain_range);
        get_tx_subtree()
            ->create<double>("freq/value")
            .set_coercer(std::bind(&db_kintex7sdr_xcvr::set_tx_freq, this, std::placeholders::_1))
            .set(db_kintex7sdr_freq_range.start());
        get_tx_subtree()->create<meta_range_t>("freq/range").set(db_kintex7sdr_freq_range);
        get_tx_subtree()
            ->create<std::vector<std::string>>("antenna/options")
            .set(db_kintex7sdr_tx_antennas);
        get_tx_subtree()
            ->create<std::string>("antenna/value")
            .set_coercer(std::bind(&db_kintex7sdr_xcvr::set_tx_ant, this, std::placeholders::_1))
            .set(db_kintex7sdr_tx_antennas.at(0));
        ...
        get_tx_subtree()
            ...
            .add_coerced_subscriber(
                std::bind(&db_kintex7sdr_xcvr::set_sync_delay, this, true, std::placeholders::_1))
            .set(0);
        get_tx_subtree()
            ->create<bool>("calibrate_vco_map")
            .add_coerced_subscriber(
                std::bind(&db_kintex7sdr_xcvr::calibrate_vco_maps, this, TX_DIRECTION));
        get_tx_subtree()
            ->create<std::map<uint8_t, uhd::range_t>>("LO1/vco_map")
            .add_coerced_subscriber(std::bind(
                &db_kintex7sdr_xcvr::set_vco_map, this, TX_DIRECTION, 1, std::placeholders::_1))
            .set_publisher(std::bind(&db_kintex7sdr_xcvr::get_vco_map, this, TX_DIRECTION, 1));
        get_tx_subtree()
            ->create<std::map<uint8_t, uhd::range_t>>("LO2/vco_map")
            .add_coerced_subscriber(std::bind(
                &db_kintex7sdr_xcvr::set_vco_map, this, TX_DIRECTION, 2, std::placeholders::_1))
            .set_publisher(std::bind(&db_kintex7sdr_xcvr::get_vco_map, this, TX_DIRECTION, 2));
        ...
        get_rx_subtree()
            ->create<sensor_value_t>("sensors/lo_locked")
            .set_publisher(std::bind(&db_kintex7sdr_xcvr::get_locked, this, "RXLO"));
        get_rx_subtree()
            ->create<double>("gains/PGA0/value")
            .set_coercer(std::bind(&db_kintex7sdr_xcvr::set_rx_gain, this, std::placeholders::_1))
            .set(0);
        get_rx_subtree()->create<meta_range_t>("gains/PGA0/range").set(db_kintex7sdr_rx_gain_range);
        get_rx_subtree()
            ->create<double>("freq/value")
            .set_coercer(std::bind(&db_kintex7sdr_xcvr::set_rx_freq, this, std::placeholders::_1))
            .set(db_kintex7sdr_freq_range.start());
        get_rx_subtree()->create<meta_range_t>("freq/range").set(db_kintex7sdr_freq_range);
        get_rx_subtree()
            ->create<std::vector<std::string>>("antenna/options")
            .set(db_kintex7sdr_rx_antennas);
        get_rx_subtree()
            ->create<std::string>("antenna/value")
            .set_coercer(std::bind(&db_kintex7sdr_xcvr::set_rx_ant, this, std::placeholders::_1))
            .set("RX2");
        ...
        get_rx_subtree()
            ->create<int64_t>("sync_delay")
            .add_coerced_subscriber(
                std::bind(&db_kintex7sdr_xcvr::set_sync_delay, this, false, std::placeholders::_1))
            .set(0);
        get_rx_subtree()
            ->create<bool>("calibrate_vco_map")
            .add_coerced_subscriber(
                std::bind(&db_kintex7sdr_xcvr::calibrate_vco_maps, this, RX_DIRECTION));
        get_rx_subtree()
            ->create<std::map<uint8_t, uhd::range_t>>("LO1/vco_map")
            .add_coerced_subscriber(std::bind(
                &db_kintex7sdr_xcvr::set_vco_map, this, RX_DIRECTION, 1, std::placeholders::_1))
            .set_publisher(std::bind(&db_kintex7sdr_xcvr::get_vco_map, this, RX_DIRECTION, 1));
        get_rx_subtree()
            ->create<std::map<uint8_t, uhd::range_t>>("LO2/vco_map")
            .add_coerced_subscriber(std::bind(
                &db_kintex7sdr_xcvr::set_vco_map, this, RX_DIRECTION, 2, std::placeholders::_1))
            .set_publisher(std::bind(&db_kintex7sdr_xcvr::get_vco_map, this, RX_DIRECTION, 2));
    }

    ~db_kintex7sdr_xcvr(void) override
    {
        UHD_SAFE_CALL(
...
private:
    ...
    void set_cpld_field(db_kintex7sdr_cpld_field_id_t id, uint32_t value)
    {
    ...
    void set_gpio_field(db_kintex7sdr_gpio_field_id_t id, uint32_t value)
    {
        // Look up field info
        std::map<db_kintex7sdr_gpio_field_id_t, db_kintex7sdr_gpio_field_info_t>::iterator entry =
            _gpio_map.find(id);
        if (entry == _gpio_map.end())
            return;
        db_kintex7sdr_gpio_field_info_t field_info = entry->second;
        if (field_info.direction == db_kintex7sdr_gpio_field_info_t::OUTPUT)
            return;
        db_kintex7sdr_gpio_reg_t* reg =
    ...
    uint32_t get_gpio_field(db_kintex7sdr_gpio_field_id_t id)
    {
        // Look up field info
        std::map<db_kintex7sdr_gpio_field_id_t, db_kintex7sdr_gpio_field_info_t>::iterator entry =
            _gpio_map.find(id);
        if (entry == _gpio_map.end())
            return 0;
        db_kintex7sdr_gpio_field_info_t field_info = entry->second;
        if (field_info.direction == db_kintex7sdr_gpio_field_info_t::INPUT) {
            db_kintex7sdr_gpio_reg_t* reg = (field_info.unit == dboard_iface::UNIT_TX
                                       ? &_tx_gpio_reg
                                       : &_rx_gpio_reg);
    ...
    void sync_phase(uhd::time_spec_t cmd_time, uhd::direction_t dir)
    {
        ...
        if (cmd_time != uhd::time_spec_t(0.0)) {
            ...
            // Assert SYNC
            db_kintex7sdr_gpio_field_info_t lo1_field_info =
                _gpio_map.find(dir == TX_DIRECTION ? TXLO1_SYNC : RXLO1_SYNC)->second;
            db_kintex7sdr_gpio_field_info_t lo2_field_info =
    ...
    sensor_value_t get_locked(const std::string& pll_name)
    {
        ...
        assert_has(db_kintex7sdr_plls, pll_name, "db_kintex7sdr pll name");
    ...
    {
        // validate input
        assert_has(db_kintex7sdr_tx_antennas, ant, "db_kintex7sdr tx antenna name");
    ...
    std::string set_rx_ant(const std::string& ant)
    {
        std::lock_guard<std::mutex> lock(_mutex);
        // validate input
        assert_has(db_kintex7sdr_rx_antennas, ant, "db_kintex7sdr rx antenna name");
    ...
    {
        std::lock_guard<std::mutex> lock(_mutex);
        gain              = db_kintex7sdr_tx_gain_range.clip(gain);
        int attn_code     = int(std::floor(gain * 2));
        _db_kintex7sdr_tx_atten_val = ((attn_code & 0x3F) << 10);
        set_gpio_field(TX_GAIN, attn_code);
        write_gpio();
        UHD_LOGGER_TRACE("DB_KINTEX7SDR")
            << boost::format("DB_KINTEX7SDR TX Gain: %f dB, Code: %d, IO Bits 0x%04x") % gain
                   % attn_code % _db_kintex7sdr_tx_atten_val;
        _tx_gain = gain;
        return gain;
    }
    ...
    {
        std::lock_guard<std::mutex> lock(_mutex);
        gain              = db_kintex7sdr_rx_gain_range.clip(gain);
        int attn_code     = int(std::floor(gain * 2));
        _db_kintex7sdr_rx_atten_val = ((attn_code & 0x3F) << 10);
        set_gpio_field(RX_GAIN, attn_code);
        write_gpio();
        UHD_LOGGER_TRACE("DB_KINTEX7SDR")
            << boost::format("DB_KINTEX7SDR RX Gain: %f dB, Code: %d, IO Bits 0x%04x") % gain
                   % attn_code % _db_kintex7sdr_rx_atten_val;
        _rx_gain = gain;
        return gain;
    }
    ...
    double set_tx_freq(double freq)
    {
        ...
        UHD_LOGGER_TRACE("DB_KINTEX7SDR")
            << boost::format("DB_KINTEX7SDR TX: the requested frequency is %f MHz") % (freq / 1e6);
        ...
        if (is_int_n and tune_args.has_key("int_n_step")) {
            ...
            if (target_pfd_freq > _tx_target_pfd_freq) {
                UHD_LOGGER_WARNING("DB_KINTEX7SDR")
                    << boost::format(
        ...
        freq = db_kintex7sdr_freq_range.clip(freq);
        ...
        UHD_LOGGER_TRACE("DB_KINTEX7SDR")
            << boost::format("DB_KINTEX7SDR TX: the actual frequency is %f MHz") % (_tx_freq / 1e6);
    ...
    double set_rx_freq(double freq)
    {
        ...
        UHD_LOGGER_TRACE("DB_KINTEX7SDR")
            << boost::format("DB_KINTEX7SDR RX: the requested frequency is %f MHz") % (freq / 1e6);
        ...
        UHD_LOGGER_TRACE("DB_KINTEX7SDR")
            << boost::format("DB_KINTEX7SDR RX: the actual frequency is %f MHz") % (_rx_freq / 1e6);
    ...
    std::mutex _mutex;
    db_kintex7sdr_cpld_reg_t _cpld_reg;
    uint32_t _prev_cpld_value;
    std::map<db_kintex7sdr_gpio_field_id_t, db_kintex7sdr_gpio_field_info_t> _gpio_map;
    ...
    bool _txlo_locked;
    std::string _rx_ant;
    int _db_kintex7sdr_tx_atten_val;
    int _db_kintex7sdr_rx_atten_val;
    power_mode_t _power_mode;
    xcvr_mode_t _xcvr_mode;
    size_t _rev;
    db_kintex7sdr_gpio_reg_t _tx_gpio_reg;
    db_kintex7sdr_gpio_reg_t _rx_gpio_reg;
...
/***********************************************************************
 * Register the DB_KINTEX7SDR dboard (min freq, max freq, rx div2, tx div2)
 **********************************************************************/
static dboard_base::sptr make_db_kintex7sdr(dboard_base::ctor_args_t args)
{
    return dboard_base::sptr(new db_kintex7sdr_xcvr(args));
}

UHD_STATIC_BLOCK(reg_db_kintex7sdr_dboards)
{
    dboard_manager::register_dboard(
        DB_KINTEX7SDR_PROTO_V3_RX_ID, DB_KINTEX7SDR_PROTO_V3_TX_ID, &make_db_kintex7sdr, "DB_KINTEX7SDR v0.3");
    dboard_manager::register_dboard(
        DB_KINTEX7SDR_PROTO_V4_RX_ID, DB_KINTEX7SDR_PROTO_V4_TX_ID, &make_db_kintex7sdr, "DB_KINTEX7SDR v0.4");
    dboard_manager::register_dboard(
        DB_KINTEX7SDR_V1_40MHZ_RX_ID, DB_KINTEX7SDR_V1_40MHZ_TX_ID, &make_db_kintex7sdr, "DB_KINTEX7SDR-40 v1");
    dboard_manager::register_dboard(
        DB_KINTEX7SDR_V1_160MHZ_RX_ID, DB_KINTEX7SDR_V1_160MHZ_TX_ID, &make_db_kintex7sdr, "DB_KINTEX7SDR-160 v1");
    dboard_manager::register_dboard(
        DB_KINTEX7SDR_V2_40MHZ_RX_ID, DB_KINTEX7SDR_V2_40MHZ_TX_ID, &make_db_kintex7sdr, "DB_KINTEX7SDR-40 v2");
    dboard_manager::register_dboard(
        DB_KINTEX7SDR_V2_160MHZ_RX_ID, DB_KINTEX7SDR_V2_160MHZ_TX_ID, &make_db_kintex7sdr, "DB_KINTEX7SDR-160 v2");
    dboard_manager::register_dboard(
        DB_KINTEX7SDR_LP_160MHZ_RX_ID, DB_KINTEX7SDR_LP_160MHZ_TX_ID, &make_db_kintex7sdr, "DB_KINTEX7SDR-160-LP");
    dboard_manager::register_dboard(
        DB_KINTEX7SDR_TDD_160MHZ_RX_ID, DB_KINTEX7SDR_TDD_160MHZ_TX_ID, &make_db_kintex7sdr, "DB_KINTEX7SDR-TDD");
}
