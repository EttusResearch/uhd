...
#ifndef INCLUDED_CRIMSON_STR_IFACE_HPP
#define INCLUDED_CRIMSON_STR_IFACE_HPP
 ...
 */
class crimson_str_iface : public uhd::wb_iface
{
public:
    typedef boost::shared_ptr<crimson_str_iface> sptr;
    /*!
