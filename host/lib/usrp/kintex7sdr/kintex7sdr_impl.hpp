...
#ifndef INCLUDED_KINTEX7SDR_IMPL_HPP
#define INCLUDED_KINTEX7SDR_IMPL_HPP
...
uhd::device_addrs_t kintex7sdr_find(const uhd::device_addr_t& hint_);

//! Make a kintex7sdr dboard interface.
uhd::usrp::dboard_iface::sptr make_kintex7sdr_dboard_iface(uhd::timed_wb_iface::sptr wb_iface,
    uhd::i2c_iface::sptr i2c_iface,
    uhd::spi_iface::sptr spi_iface,
    kintex7sdr_clock_ctrl::sptr clk_ctrl);

/*!
 * KINTEX7SDR implementation guts:
 * The implementation details are encapsulated here.
 * Handles device properties and streaming...
 */
class kintex7sdr_impl : public uhd::device
{
public:
    kintex7sdr_impl(const uhd::device_addr_t&);
    ~kintex7sdr_impl(void) override;
    ...
    static uhd::usrp::mboard_eeprom_t get_mb_eeprom(kintex7sdr_iface&);

private:
    struct mb_container_type
    {
        kintex7sdr_iface::sptr iface;
        usrp2_fifo_ctrl::sptr fifo_ctrl;
        uhd::spi_iface::sptr spiface;
        uhd::timed_wb_iface::sptr wbiface;
        kintex7sdr_clock_ctrl::sptr clock;
        kintex7sdr_codec_ctrl::sptr codec;
    ...
    void program_stream_dest(
        uhd::transport::zero_copy_if::sptr&, const uhd::stream_args_t&);
};

#endif /* INCLUDED_KINTEX7SDR_IMPL_HPP */
