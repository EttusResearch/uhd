...
mboard_eeprom_t kintex7sdr_impl::get_mb_eeprom(kintex7sdr_iface& iface)
{
    ...
    // Older kintex7sdr models don't have a serial burned into EEPROM.
...
void kintex7sdr_impl::set_mb_eeprom(const std::string& mb, const mboard_eeprom_t& mb_eeprom)
{
