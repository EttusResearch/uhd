...
DECLARE_CONVERTER_AVX2(sc16, 1, sc16_item32_le, 1, PRIORITY_SIMD_AVX2)
{
...
DECLARE_CONVERTER_AVX2(sc16, 1, sc16_item32_be, 1, PRIORITY_SIMD_AVX2)
{
    const sc16_t* input = reinterpret_cast<const sc16_t*>(inputs[0]);
    item32_t* output    = reinterpret_cast<item32_t*>(outputs[0]);
...
DECLARE_CONVERTER_AVX2(sc16_item32_le, 1, sc16, 1, PRIORITY_SIMD_AVX2)
{
...
DECLARE_CONVERTER_AVX2(sc16_item32_be, 1, sc16, 1, PRIORITY_SIMD_AVX2)
{
    const item32_t* input = reinterpret_cast<const item32_t*>(inputs[0]);
    sc16_t* output        = reinterpret_cast<sc16_t*>(outputs[0]);
