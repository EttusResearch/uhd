...
DECLARE_CONVERTER_SSE2(sc16_item32_le, 1, fc64, 1, PRIORITY_SIMD)
{
...
DECLARE_CONVERTER_SSE2(sc16_item32_be, 1, fc64, 1, PRIORITY_SIMD)
{
    const item32_t* input = reinterpret_cast<const item32_t*>(inputs[0]);
    fc64_t* output        = reinterpret_cast<fc64_t*>(outputs[0]);
...
DECLARE_CONVERTER_SSE2(sc16_chdr, 1, fc64, 1, PRIORITY_SIMD)
{
