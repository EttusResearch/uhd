...
DECLARE_CONVERTER_SSE2(fc32, 1, sc16_item32_le, 1, PRIORITY_SIMD)
{
...
DECLARE_CONVERTER_SSE2(fc32, 1, sc16_item32_be, 1, PRIORITY_SIMD)
{
    const fc32_t* input = reinterpret_cast<const fc32_t*>(inputs[0]);
    item32_t* output    = reinterpret_cast<item32_t*>(outputs[0]);
...
DECLARE_CONVERTER_SSE2(fc32, 1, sc16_chdr, 1, PRIORITY_SIMD)
{
    const fc32_t* input = reinterpret_cast<const fc32_t*>(inputs[0]);
