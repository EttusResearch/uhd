...
DECLARE_CONVERTER(sc16_item32_le, 1, fc64, 1, PRIORITY_SIMD)
{
    ...
    for (; i + 7 < nsamps; i += 8) {
        ...
        __m256d tmp0 =
            _mm256_mul_pd(_mm256_cvtepi32_pd(_mm256_castsi256_si128(int32_lo)), scalar);
        __m256d tmp1 = _mm256_mul_pd(
            _mm256_cvtepi32_pd(_mm256_extracti128_si256(int32_lo, 1)), scalar);
        __m256d tmp2 =
            _mm256_mul_pd(_mm256_cvtepi32_pd(_mm256_castsi256_si128(int32_hi)), scalar);
        __m256d tmp3 = _mm256_mul_pd(
            _mm256_cvtepi32_pd(_mm256_extracti128_si256(int32_hi, 1)), scalar);
