...
#ifndef INCLUDED_LIBUHD_FIR_FILTER_BLOCK_CONTROL_HPP
#define INCLUDED_LIBUHD_FIR_FILTER_BLOCK_CONTROL_HPP
...
#endif /* INCLUDED_LIBUHD_FIR_FILTER_BLOCK_CONTROL_HPP */
