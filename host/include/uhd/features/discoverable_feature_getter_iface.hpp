...
public:
    ...
    /*! \brief Retrieves a feature of the specified type.
     *
    ...
    /*! \brief Determines whether a given feature exists
     *
    ...
    /*! \brief Enumerate all discoverable features present on the device.
     *
...
private:
    /*! \brief Get a shared pointer to a feature, if it exists.
     *
