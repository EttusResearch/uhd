 ...
 */
class x4xx_mock_rpc_server : public uhd::rpc_client,
                             public std::enable_shared_from_this<x4xx_mock_rpc_server>
{
public:
    ...
    {
    public:
        mock_dboard_iface(x4xx_mock_rpc_server* parent) : _parent(parent) {}
        ...
        // X400-specific dboard methods (actually used by ZBX)
